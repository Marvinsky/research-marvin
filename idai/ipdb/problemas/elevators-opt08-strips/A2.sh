...
src/search/downward-release --global_probes 100 --domain_name elevators-opt08-strips --problem_name p02.pddl --heuristic_name ipdb  --search "idai(ipdb(max_time=600))" <  Astarelevators-opt08-strips2 > ${RESULTS}/p02.pddl
