...
src/search/downward-release --global_probes 100 --domain_name parcprinter-opt11-strips --problem_name p02.pddl --heuristic_name ipdb  --search "idai(ipdb(max_time=600))" <  Astarparcprinter-opt11-strips2 > ${RESULTS}/p02.pddl
