...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-6-1.pddl --heuristic_name hmax  --search "idai(hmax())" <  Astarblocks8 > ${RESULTS}/probBLOCKS-6-1.pddl
