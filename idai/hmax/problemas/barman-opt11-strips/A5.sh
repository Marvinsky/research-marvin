...
src/search/downward-release --global_probes 100 --domain_name barman-opt11-strips --problem_name pfile02-005.pddl --heuristic_name hmax  --search "idai(hmax())" <  Astarbarman-opt11-strips5 > ${RESULTS}/pfile02-005.pddl
