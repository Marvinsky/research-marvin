...
src/search/downward-release --use_saved_pdbs --F_boundary 42  --global_probes 1000 --domain_name elevators-opt08-strips --problem_name p01.pddl --heuristic_name gapdb --search "ss(min([gapdb(mp=0.5), automate_GAs]))" <  Astarelevators-opt08-strips1 > ${RESULTS}/p01.pddl
