...
src/search/downward-release --F_boundary 30 --use_saved_pdbs --global_probes 1000 --domain_name scanalyzer-opt11-strips --problem_name p14.pddl --heuristic_name gapdb --search "ss(min([gapdb(mp=0.5), automate_GAs]))" <  Astarscanalyzer-opt11-strips7 > ${RESULTS}/p14.pddl
