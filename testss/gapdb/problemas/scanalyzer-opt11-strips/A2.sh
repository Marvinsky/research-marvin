...
src/search/downward-release --F_boundary 22 --use_saved_pdbs --global_probes 1000 --domain_name scanalyzer-opt11-strips --problem_name p02.pddl --heuristic_name gapdb --search "ss(min([gapdb(mp=0.5), automate_GAs]))" <  Astarscanalyzer-opt11-strips2 > ${RESULTS}/p02.pddl
