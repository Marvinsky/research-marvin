...
src/search/downward-release --F_boundary 26 --global_probes 1000 --domain_name scanalyzer-opt11-strips --problem_name p03.pddl --heuristic_name gapdb --search "ss(min([gapdb(mp=0.5), automate_GAs]))" <  Astarscanalyzer-opt11-strips3 > ${RESULTS}/p03.pddl
