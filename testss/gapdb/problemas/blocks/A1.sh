...
src/search/downward-release --F_boundary 6 --use_saved_pdbs --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-4-0.pddl --heuristic_name gapdb --search "ss(min([gapdb(mp=0.5), automate_GAs]))" <  Astarblocks1 > ${RESULTS}/probBLOCKS-4-0.pddl
