...
src/search/downward-release --F_boundary 10 --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-4-1.pddl --heuristic_name gapdb --search "ss(min([gapdb(mp=0.5), automate_GAs]))" <  Astarblocks2 > ${RESULTS}/probBLOCKS-4-1.pddl
