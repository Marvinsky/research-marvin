...
src/search/downward-release --F_boundary 26 --global_probes 1000 --domain_name scanalyzer-opt11-strips --problem_name p11.pddl --heuristic_name gapdb --search "ss(min([gapdb(mp=0.5), automate_GAs]))" <  Astarscanalyzer-opt11-strips5 > ${RESULTS}/p11.pddl
