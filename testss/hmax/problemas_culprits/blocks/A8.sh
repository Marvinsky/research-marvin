...
src/search/downward-release --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-6-1.pddl --heuristic_name hmax --search "ss(hmax())" <  Astarblocks8 >> ${RESULTS}/probBLOCKS-6-1.pddl
