...
src/search/downward-release --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-7-0.pddl --heuristic_name hmax --search "ss(hmax())" <  Astarblocks10 >> ${RESULTS}/probBLOCKS-7-0.pddl
