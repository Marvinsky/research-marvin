...
src/search/downward-release --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-5-2.pddl --heuristic_name hmax --search "ss(hmax())" <  Astarblocks6 >> ${RESULTS}/probBLOCKS-5-2.pddl
