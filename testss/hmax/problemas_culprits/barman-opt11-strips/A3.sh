...
src/search/downward-release --global_probes 1000 --domain_name barman-opt11-strips --problem_name pfile01-003.pddl --heuristic_name hmax --search "ss(hmax())" <  Astarbarman-opt11-strips3 >> ${RESULTS}/pfile01-003.pddl
