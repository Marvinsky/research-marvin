...
src/search/downward --global_probes 1 --domain_name barman-opt11-strips --problem_name pfile01-001.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astarbarman-opt11-strips1 >> ${RESULTS}/pfile01-001.pddl
