...
src/search/downward-release --global_probes 1000 --domain_name barman-opt11-strips --problem_name pfile03-012.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astarbarman-opt11-strips12 > ${RESULTS}/pfile03-012.pddl
