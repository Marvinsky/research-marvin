...
src/search/downward-release --global_probes 1000 --domain_name barman-opt11-strips --problem_name pfile01-004.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astarbarman-opt11-strips4 > ${RESULTS}/pfile01-004.pddl
