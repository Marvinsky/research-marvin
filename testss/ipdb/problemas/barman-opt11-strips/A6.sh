...
src/search/downward-release --global_probes 1000 --domain_name barman-opt11-strips --problem_name pfile02-006.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astarbarman-opt11-strips6 > ${RESULTS}/pfile02-006.pddl
