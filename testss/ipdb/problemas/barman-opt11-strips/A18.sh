...
src/search/downward-release --global_probes 1000 --domain_name barman-opt11-strips --problem_name pfile05-018.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astarbarman-opt11-strips18 > ${RESULTS}/pfile05-018.pddl
