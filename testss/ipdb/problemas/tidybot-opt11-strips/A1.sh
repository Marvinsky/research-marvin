...
src/search/downward-release --global_probes 1000 --domain_name tidybot-opt11-strips --problem_name p10.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astartidybot-opt11-strips1 > ${RESULTS}/p10.pddl
