...
src/search/downward --global_probes 10000 --domain_name blocks --problem_name probBLOCKS-8-1.pddl --heuristic_name ipdb --search "ss2(ipdb(pdb_max_size=2000000, collection_max_size=20000000, num_samples=100, min_improvement=10, cost_type=NORMAL))" <  Astarblocks14 >> ${RESULTS}/probBLOCKS-8-1.pddl
