...
src/search/downward --global_probes 10000 --domain_name blocks --problem_name probBLOCKS-4-1.pddl --heuristic_name ipdb --search "ss2(ipdb())" <  Astarblocks2 >> ${RESULTS}/probBLOCKS-4-1.pddl
