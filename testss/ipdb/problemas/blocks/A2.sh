...
src/search/downward-release --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-4-1.pddl --heuristic_name ipdb --search "ss(ipdb(max_time=600))" <  Astarblocks2 > ${RESULTS}/probBLOCKS-4-1.pddl
