...
src/search/downward-release --F_boundary 12 --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-5-1.pddl --heuristic_name ipdb --search "ss(ipdb(max_time=600))" <  Astarblocks5 > ${RESULTS}/probBLOCKS-5-1.pddl
