...
src/search/downward --global_probes 10000 --domain_name blocks --problem_name probBLOCKS-11-2.pddl --heuristic_name ipdb --search "ss2(ipdb(pdb_max_size=2000000, collection_max_size=20000000, num_samples=100, min_improvement=10, cost_type=NORMAL))" <  Astarblocks24 >> ${RESULTS}/probBLOCKS-11-2.pddl
