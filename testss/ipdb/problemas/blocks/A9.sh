...
src/search/downward --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-6-2.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astarblocks9 >> ${RESULTS}/probBLOCKS-6-2.pddl
