...
src/search/downward --global_probes 10000 --domain_name blocks --problem_name probBLOCKS-7-0.pddl --heuristic_name ipdb --search "ss2(ipdb())" <  Astarblocks10 >> ${RESULTS}/probBLOCKS-7-0.pddl
