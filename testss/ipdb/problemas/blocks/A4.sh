...
src/search/downward --global_probes 10000 --domain_name blocks --problem_name probBLOCKS-5-0.pddl --heuristic_name ipdb --search "ss2(ipdb())" <  Astarblocks4 >> ${RESULTS}/probBLOCKS-5-0.pddl
