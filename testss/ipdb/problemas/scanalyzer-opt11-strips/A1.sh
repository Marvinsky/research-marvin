...
src/search/downward --global_probes 1 --domain_name scanalyzer-opt11-strips --problem_name p01.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astarscanalyzer-opt11-strips1 >> ${RESULTS}/p01.pddl
