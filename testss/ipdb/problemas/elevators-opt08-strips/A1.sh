...
src/search/downward-release --F_boundary 42 --global_probes 1000 --domain_name elevators-opt08-strips --problem_name p01.pddl --heuristic_name ipdb --search "ss(ipdb(max_time=600))" <  Astarelevators-opt08-strips1 > ${RESULTS}/p01.pddl
