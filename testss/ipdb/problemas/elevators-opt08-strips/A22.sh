...
src/search/downward-release --F_boundary 55 --global_probes 1000 --domain_name elevators-opt08-strips --problem_name p22.pddl --heuristic_name ipdb --search "ss(ipdb(max_time=600))" <  Astarelevators-opt08-strips22 > ${RESULTS}/p22.pddl
