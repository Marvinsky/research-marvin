...
src/search/downward --global_probes 50 --domain_name parcprinter-opt11-strips --problem_name p02.pddl --heuristic_name ipdb --search "ss(ipdb(pdb_max_size=2000000, collection_max_size=20000000, num_samples=1000, min_improvement=10, cost_type=NORMAL))" <  Astarparcprinter-opt11-strips2 >> ${RESULTS}/p02.pddl
