...
src/search/downward-release --F_boundary 438048 --global_probes 1000 --domain_name parcprinter-opt11-strips --problem_name p02.pddl --heuristic_name ipdb --search "ss(ipdb(max_time=600))" <  Astarparcprinter-opt11-strips2 > ${RESULTS}/p02.pddl
