...
src/search/downward-release --F_boundary 375821 --global_probes 1000 --domain_name parcprinter-opt11-strips --problem_name p01.pddl --heuristic_name ipdb --search "ss(ipdb(max_time=600))" <  Astarparcprinter-opt11-strips1 > ${RESULTS}/p01.pddl
