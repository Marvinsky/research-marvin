...
src/search/downward-release --is_mov_bound --F_boundary 40 --global_probes 1000 --domain_name elevators-opt08-strips --problem_name p01_40.pddl --heuristic_name ipdb --search "ss(ipdb(max_time=600))" <  Astarelevators-opt08-strips_40 > ${RESULTS}/p01_40.pddl
