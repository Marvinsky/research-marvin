...
python3 src/translate/translate.py benchmarks/elevators-opt08-strips/p01-domain.pddl benchmarks/elevators-opt08-strips/p01.pddl Astarelevators-opt08-strips_41  elevators-opt08-strips  p01_41.pddl  ipdb
...
rm Astarelevators-opt08-strips_41



rm Astarelevators-opt08-strips_41.sas
