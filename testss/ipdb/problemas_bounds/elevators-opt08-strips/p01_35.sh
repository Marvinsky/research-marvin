...
src/search/downward-release --is_mov_bound --F_boundary 35 --global_probes 100000 --domain_name elevators-opt08-strips --problem_name p01_35.pddl --heuristic_name ipdb --search "ss(ipdb(max_time=600))" <  Astarelevators-opt08-strips_35 > ${RESULTS}/p01_35.pddl
