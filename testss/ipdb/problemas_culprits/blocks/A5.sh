...
src/search/downward-release --global_probes 10000 --domain_name blocks --problem_name probBLOCKS-5-1.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astarblocks5 >> ${RESULTS}/probBLOCKS-5-1.pddl
