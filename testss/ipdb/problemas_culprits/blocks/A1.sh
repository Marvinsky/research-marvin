...
src/search/downward-release --global_probes 10000 --domain_name blocks --problem_name probBLOCKS-4-0.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astarblocks1 >> ${RESULTS}/probBLOCKS-4-0.pddl
