...
src/search/downward-release --global_probes 10000 --domain_name blocks --problem_name probBLOCKS-6-1.pddl --heuristic_name ipdb --search "ss(ipdb())" <  Astarblocks8 >> ${RESULTS}/probBLOCKS-6-1.pddl
