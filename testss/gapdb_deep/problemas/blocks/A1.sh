...
src/search/downward-release --domain_name blocks --problem_name probBLOCKS-4-0.pddl --heuristic_name gapdb_deep --search "ss(min([lmcut(), ipdb(max_time=600), merge_and_shrink(), automate_GAs]))" <  Astarblocks1 > ${RESULTS}/probBLOCKS-4-0.pddl
