...
src/search/downward --global_probes 1000 --domain_name elevators-opt11-strips --problem_name p19.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarelevators-opt11-strips19 >> ${RESULTS}/p19.pddl
