...
src/search/downward --domain_name elevators-opt11-strips --problem_name p18.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarelevators-opt11-strips18 >> ${RESULTS}/p18.pddl
