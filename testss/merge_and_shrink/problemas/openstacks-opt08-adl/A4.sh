...
src/search/downward --global_probes 1000 --domain_name openstacks-opt08-adl --problem_name p04.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astaropenstacks-opt08-adl4 >> ${RESULTS}/p04.pddl
