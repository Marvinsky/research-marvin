...
src/search/downward --domain_name openstacks-opt08-adl --problem_name p07.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astaropenstacks-opt08-adl7 >> ${RESULTS}/p07.pddl
