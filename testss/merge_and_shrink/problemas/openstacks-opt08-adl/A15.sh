...
src/search/downward --global_probes 1000 --domain_name openstacks-opt08-adl --problem_name p15.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astaropenstacks-opt08-adl15 >> ${RESULTS}/p15.pddl
