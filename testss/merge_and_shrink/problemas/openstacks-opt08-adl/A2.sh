...
src/search/downward --global_probes 1000 --domain_name openstacks-opt08-adl --problem_name p02.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astaropenstacks-opt08-adl2 >> ${RESULTS}/p02.pddl
