...
src/search/downward --domain_name elevators-opt08-strips --problem_name p01.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarelevators-opt08-strips1 >> ${RESULTS}/p01.pddl
