...
src/search/downward --global_probes 1000 --domain_name transport-opt08-strips --problem_name p25.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astartransport-opt08-strips25 >> ${RESULTS}/p25.pddl
