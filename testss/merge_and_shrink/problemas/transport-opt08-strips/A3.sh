...
src/search/downward --global_probes 1000 --domain_name transport-opt08-strips --problem_name p03.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astartransport-opt08-strips3 >> ${RESULTS}/p03.pddl
