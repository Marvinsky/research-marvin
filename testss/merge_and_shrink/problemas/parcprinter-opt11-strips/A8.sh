...
src/search/downward --domain_name parcprinter-opt11-strips --problem_name p08.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarparcprinter-opt11-strips8 >> ${RESULTS}/p08.pddl
