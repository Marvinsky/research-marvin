...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile06-022.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarparking-opt11-strips12 >> ${RESULTS}/pfile06-022.pddl
