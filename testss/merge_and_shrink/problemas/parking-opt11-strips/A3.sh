...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile04-013.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarparking-opt11-strips3 >> ${RESULTS}/pfile04-013.pddl
