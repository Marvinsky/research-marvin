...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile08-029.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarparking-opt11-strips19 >> ${RESULTS}/pfile08-029.pddl
