...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile05-017.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarparking-opt11-strips7 >> ${RESULTS}/pfile05-017.pddl
