...
src/search/downward --global_probes 1000 --domain_name pegsol-opt11-strips --problem_name p02.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarpegsol-opt11-strips2 >> ${RESULTS}/p02.pddl
