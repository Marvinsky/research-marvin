...
src/search/downward --domain_name pegsol-opt11-strips --problem_name p10.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarpegsol-opt11-strips10 >> ${RESULTS}/p10.pddl
