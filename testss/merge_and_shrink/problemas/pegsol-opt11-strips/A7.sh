...
src/search/downward --global_probes 1000 --domain_name pegsol-opt11-strips --problem_name p07.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarpegsol-opt11-strips7 >> ${RESULTS}/p07.pddl
