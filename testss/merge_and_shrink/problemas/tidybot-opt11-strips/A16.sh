...
src/search/downward --domain_name tidybot-opt11-strips --problem_name p16.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astartidybot-opt11-strips16 >> ${RESULTS}/p16.pddl
