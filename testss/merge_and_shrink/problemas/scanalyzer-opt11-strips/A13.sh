...
src/search/downward --domain_name scanalyzer-opt11-strips --problem_name p13.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarscanalyzer-opt11-strips13 >> ${RESULTS}/p13.pddl
