...
src/search/downward --global_probes 1000 --domain_name scanalyzer-opt11-strips --problem_name p06.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarscanalyzer-opt11-strips6 >> ${RESULTS}/p06.pddl
