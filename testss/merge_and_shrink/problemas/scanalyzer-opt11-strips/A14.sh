...
src/search/downward --global_probes 1000 --domain_name scanalyzer-opt11-strips --problem_name p14.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarscanalyzer-opt11-strips14 >> ${RESULTS}/p14.pddl
