...
src/search/downward --domain_name woodworking-opt11-strips --problem_name p04.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarwoodworking-opt11-strips4 >> ${RESULTS}/p04.pddl
