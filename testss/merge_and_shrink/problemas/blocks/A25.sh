...
src/search/downward --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-12-0.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarblocks25 >> ${RESULTS}/probBLOCKS-12-0.pddl
