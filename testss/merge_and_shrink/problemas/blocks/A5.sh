...
src/search/downward --domain_name blocks --problem_name probBLOCKS-5-1.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarblocks5 >> ${RESULTS}/probBLOCKS-5-1.pddl
