...
ScalarEvaluator vector pointer after add g = [0x9ce3b90]
ScalarEvaluator vector pointer after add eval = [0x9ce3b90, 0x9ce4378]
subevaluators_.size:2
new vector of ScalarEvaluator created = [0x9ce5e00, 0x9ce4378]
OpenList vector of state_var_t objects = 0x9ce6550
engine = 0x9ce58e8
...
starting timings 
initial state = 0x9cdd088
node_counter = 779034
node_gen_and_exp_cost = 1,28364e-06
...
heur_name = No Name
h[,0,] is:,heur is not named,measured time cost: 7,87717e-07,h:10
memory before deleting databases: 
VmRSS memory: 16880 KB
...
rutaR = /home/marvin/marvin/test/merge_and_shrink/report/blocks/probBLOCKS-4-1.pddl
...
****************************************************************
counter in te while k = 114
Number of expanded nodes with threshold 20 = 1633799
the directory was not created
...
g object = 0x993bb90
ScalarEvaluator vector pointer []
ScalarEvaluator vector pointer after add g = [0x993bb90]
ScalarEvaluator vector pointer after add eval = [0x993bb90, 0x993c378]
subevaluators_.size:2
new vector of ScalarEvaluator created = [0x993de00, 0x993c378]
OpenList vector of state_var_t objects = 0x993e550
engine = 0x993d8e8
 ___________________________________
|         calling initialize        |
 ___________________________________
...
Conditional effects present = 0
starting timings 
initial state = 0x9935088
node_counter = 783549
node_gen_and_exp_cost = 1,27624e-06
active heuristics size : 1
# heristics = 1
dead_end = 1
Initial state is a dead end.
...
Estimated peak memory for abstraction: 486348 bytes
heur_name = No Name
h[,0,] is:,heur is not named,measured time cost: 7,55946e-07,h:10
memory before deleting databases: 
VmRSS memory: 17092 KB
memory after deleting all databases: 
VmRSS memory: 17092 KB
Remaining heuristics:
remaining initial heur heur is not named
