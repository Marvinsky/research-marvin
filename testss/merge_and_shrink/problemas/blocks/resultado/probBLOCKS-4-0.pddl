...
ScalarEvaluator vector pointer after add g = [0x87c0848]
ScalarEvaluator vector pointer after add eval = [0x87c0848, 0x87c1538]
subevaluators_.size:2
new vector of ScalarEvaluator created = [0x87c0db0, 0x87c1538]
OpenList vector of state_var_t objects = 0x87c15a8
engine = 0x87c0bd8
...
starting timings 
initial state = 0x87b8088
node_counter = 731476
node_gen_and_exp_cost = 1,3671e-06
...
heur_name = No Name
h[,0,] is:,heur is not named,measured time cost: 6,65127e-07,h:6
memory before deleting databases: 
VmRSS memory: 17588 KB
...
rutaR = /home/marvin/marvin/test/merge_and_shrink/report/blocks/probBLOCKS-4-0.pddl
...
14, 
****************************************************************
counter in te while k = 81
Number of expanded nodes with threshold 12 = 154087
