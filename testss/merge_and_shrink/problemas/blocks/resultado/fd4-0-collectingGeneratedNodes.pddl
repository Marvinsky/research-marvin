...
argv[0][0] = s
argv[1] = --search
argv[2] = lazy_greedy([dijkstra(), merge_and_shrink()])
argv[4] = XDG_VTNR=4
argv[5] = XDG_SESSION_ID=c4
argc = 3
Simplifying transitions... done!
OptionParser::parse_cmd_line
registered: lazy_greedy
registered: dijkstra
...
Node that comes from current_state: h = -1 g = -1

Parent node: h -1 g = -1 f = -2
...
Parent node: h 0 g = 0 f = 0
	Node Removed From the openlist h = 0 g = 1
	h = 7
...
Node that comes from current_state: h = 0 g = 1
...
Parent node: h 0 g = 1 f = 1
	Node Removed From the openlist h = 0 g = 2
	h = 4
...
Parent node: h 0 g = 2 f = 2
	Node Removed From the openlist h = 0 g = 3
	h = 3
...
Parent node: h 0 g = 3 f = 3
	Node Removed From the openlist h = 0 g = 4
	h = 2
...
Node that comes from current_state: h = 0 g = 3
...
Parent node: h 0 g = 4 f = 4
	Node Removed From the openlist h = 0 g = 5
	h = 1
...
Best heuristic value: 0/1 [g=5, 12 evaluated, 11 expanded, t=0.01s]
			...
			new_real_g = 6
			is_preferred = 0
				new_g evaluated is = 6
			new_g = 6
			new_real_g = 6
			is_preferred = 0
				new_g evaluated is = 6

Node that comes from current_state: h = 0 g = 0

Node that comes from current_state: h = -1 g = -1

Parent node: h 0 g = 5 f = 5
	Node Removed From the openlist h = 0 g = 6
	h = 0
...
Total time: 0.01s
Peak memory: 7616 KB
VmRSS memory: 2036 KB
VmHWM memory: 2472 KB
