...
ScalarEvaluator vector pointer after add g = [0x96b0280]
ScalarEvaluator vector pointer after add eval = [0x96b0280, 0x96b7ff0]
subevaluators_.size:2
new vector of ScalarEvaluator created = [0x96ba830, 0x96b7ff0]
OpenList vector of state_var_t objects = 0x96bab50
engine = 0x96af0b8
...
starting timings 
initial state = 0x969ced8
node_counter = 421384
node_gen_and_exp_cost = 2,37313e-06
...
Abstraction (6/15 vars): 6250 states, ???/241379 arcs, 3069228 bytes
...
Abstraction (7/15 vars): 50000 states, ???/1342297 arcs, 11065220 bytes
Abstraction (7/15 vars): distances not computed [t=1,31s]
Next variable: #7
...
Abstraction (7/15 vars): 25000 states, ???/1342297 arcs, 11240228 bytes
Abstraction (7/15 vars): init h=10, max f=24, max g=13, max h=13 [t=1,44s]
...
Abstraction (7/15 vars): 25000 states, ???/705910 arcs, 8955996 bytes
...
Abstraction (8/15 vars): 50000 states, ???/1331982 arcs, 11207700 bytes
...
Abstraction (8/15 vars): 25000 states, ???/1331982 arcs, 11382708 bytes
...
Abstraction (8/15 vars): 25000 states, ???/694830 arcs, 8820548 bytes
...
Abstraction (9/15 vars): 50000 states, ???/1304277 arcs, 10986060 bytes
...
Abstraction (9/15 vars): 25000 states, ???/1304277 arcs, 11161068 bytes
Abstraction (9/15 vars): init h=10, max f=24, max g=15, max h=13 [t=1,8s]
...
Abstraction (9/15 vars): 25000 states, ???/728626 arcs, 9246532 bytes
Abstraction (9/15 vars): init h=10, max f=24, max g=15, max h=13 [t=1,89s]
Atomic abstraction #5: normalizing without label reduction
Atomic abstraction #5: 2 states, ???/39 arcs, 1808 bytes
Atomic abstraction #5: init h=0, max f=1, max g=1, max h=0 [t=1,89s]
Merging abstraction (9/15 vars) and atomic abstraction #5
Abstraction (10/15 vars): 50000 states, ???/1364202 arcs, 11465460 bytes
...
Abstraction (10/15 vars): 25000 states, ???/1364202 arcs, 11640468 bytes
...
Abstraction (10/15 vars): 25000 states, ???/790490 arcs, 10590020 bytes
Abstraction (10/15 vars): init h=11, max f=24, max g=15, max h=14 [t=2,09s]
Atomic abstraction #4: normalizing without label reduction
Atomic abstraction #4: 2 states, ???/39 arcs, 1808 bytes
Atomic abstraction #4: init h=0, max f=1, max g=1, max h=0 [t=2,09s]
Merging abstraction (10/15 vars) and atomic abstraction #4
Abstraction (11/15 vars): 50000 states, ???/1477863 arcs, 12374748 bytes
Abstraction (11/15 vars): distances not computed [t=2,1s]
Next variable: #3
...
Abstraction (11/15 vars): 25000 states, ???/1477863 arcs, 12549756 bytes
Abstraction (11/15 vars): init h=11, max f=24, max g=15, max h=14 [t=2,21s]
Atomic abstraction #3: 2 states, ???/39 arcs, 1808 bytes
Atomic abstraction #3: init h=0, max f=1, max g=1, max h=0 [t=2,21s]
Abstraction (11/15 vars): normalizing with label reduction
Label reduction: 11 pruned vars, 98 labels, 27 reduced labels
Abstraction (11/15 vars): 25000 states, ???/708231 arcs, 9312068 bytes
Abstraction (11/15 vars): init h=11, max f=24, max g=15, max h=14 [t=2,31s]
Atomic abstraction #3: normalizing without label reduction
Atomic abstraction #3: 2 states, ???/39 arcs, 1808 bytes
Atomic abstraction #3: init h=0, max f=1, max g=1, max h=0 [t=2,31s]
Merging abstraction (11/15 vars) and atomic abstraction #3
Abstraction (12/15 vars): 50000 states, ???/1316178 arcs, 11081268 bytes
Abstraction (12/15 vars): distances not computed [t=2,33s]
Next variable: #2
...
Abstraction (12/15 vars): 25000 states, ???/1316178 arcs, 11256276 bytes
Abstraction (12/15 vars): init h=14, max f=24, max g=17, max h=17 [t=2,43s]
...
Abstraction (12/15 vars): 25000 states, ???/663657 arcs, 8918852 bytes
Abstraction (12/15 vars): init h=14, max f=24, max g=17, max h=17 [t=2,5s]
Atomic abstraction #2: normalizing without label reduction
Atomic abstraction #2: 2 states, ???/39 arcs, 1808 bytes
Atomic abstraction #2: init h=0, max f=1, max g=1, max h=0 [t=2,5s]
Merging abstraction (12/15 vars) and atomic abstraction #2
Abstraction (13/15 vars): 50000 states, ???/1241569 arcs, 10484396 bytes
Abstraction (13/15 vars): distances not computed [t=2,52s]
Next variable: #1
...
Abstraction (13/15 vars): 25000 states, ???/1241569 arcs, 10659404 bytes
Abstraction (13/15 vars): init h=14, max f=24, max g=17, max h=17 [t=2,62s]
Atomic abstraction #1: 2 states, ???/39 arcs, 1808 bytes
Atomic abstraction #1: init h=0, max f=1, max g=1, max h=0 [t=2,62s]
Abstraction (13/15 vars): normalizing with label reduction
Label reduction: 13 pruned vars, 98 labels, 17 reduced labels
Abstraction (13/15 vars): 25000 states, ???/637597 arcs, 7542596 bytes
Abstraction (13/15 vars): init h=14, max f=24, max g=17, max h=17 [t=2,69s]
...
Abstraction (14/15 vars): 50000 states, ???/1052770 arcs, 8974004 bytes
Abstraction (14/15 vars): distances not computed [t=2,71s]
Next variable: #0
...
Abstraction (14/15 vars): 6250 states, ???/1040213 arcs, 8879804 bytes
Abstraction (14/15 vars): init h=15, max f=24, max g=17, max h=17 [t=2,8s]
Atomic abstraction #0: 8 states, ???/14 arcs, 1616 bytes
Atomic abstraction #0: init h=0, max f=2, max g=2, max h=0 [t=2,8s]
Abstraction (14/15 vars): normalizing with label reduction
Label reduction: 14 pruned vars, 98 labels, 15 reduced labels
Abstraction (14/15 vars): 6250 states, ???/298899 arcs, 3441684 bytes
Abstraction (14/15 vars): init h=15, max f=24, max g=17, max h=17 [t=2,85s]
...
Abstraction (15/15 vars): 50000 states, ???/1205686 arcs, 9972332 bytes
Abstraction (15/15 vars): distances not computed [t=2,86s]
Abstraction (15/15 vars): computing distances using unit-cost algorithm
Abstraction (15/15 vars): unreachable: 856 states, irrelevant: 0 states
Abstraction (15/15 vars): shrink forced to prune unreachable/irrelevant states
Abstraction (15/15 vars): applying abstraction (50000 to 49144 states)
Abstraction (15/15 vars): applying abstraction to lookup table
Abstraction (15/15 vars): size after shrink 49144, target 50000
Abstraction (15/15 vars): shrink forced to prune unreachable/irrelevant states
Abstraction (15/15 vars): applying abstraction (49144 to 49144 states)
Abstraction (15/15 vars): applying abstraction to lookup table
Abstraction (15/15 vars): size after shrink 49144, target 49144
Abstraction (15/15 vars): distances already known
Abstraction (15/15 vars): 49144 states, ???/1202338 arcs, 10337836 bytes
Abstraction (15/15 vars): init h=17, max f=26, max g=18, max h=17 [t=2,96s]
Done initializing merge-and-shrink heuristic [1,96s]
initial h value: 17
Estimated peak memory for abstraction: 10337836 bytes
heur_name = No Name
h[,0,] is:,heur is not named,measured time cost: 1,96,h:17
memory before deleting databases: 
VmRSS memory: 42000 KB
...
Search time: 2,96s
Total time: 2,96s
Peak memory: 78436 KB
VmRSS memory: 24296 KB
VmHWM memory: 58048 KB
