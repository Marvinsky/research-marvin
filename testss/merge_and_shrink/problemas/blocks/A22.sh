...
src/search/downward --domain_name blocks --problem_name probBLOCKS-11-0.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarblocks22 >> ${RESULTS}/probBLOCKS-11-0.pddl
