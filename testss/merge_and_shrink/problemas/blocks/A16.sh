...
src/search/downward --domain_name blocks --problem_name probBLOCKS-9-0.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarblocks16 >> ${RESULTS}/probBLOCKS-9-0.pddl
