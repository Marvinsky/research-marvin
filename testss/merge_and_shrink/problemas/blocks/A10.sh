...
src/search/downward --domain_name blocks --problem_name probBLOCKS-7-0.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarblocks10 >> ${RESULTS}/probBLOCKS-7-0.pddl
