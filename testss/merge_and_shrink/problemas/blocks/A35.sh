...
src/search/downward --domain_name blocks --problem_name probBLOCKS-17-0.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarblocks35 >> ${RESULTS}/probBLOCKS-17-0.pddl
