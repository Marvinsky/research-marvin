...
src/search/downward --domain_name blocks --problem_name probBLOCKS-13-1.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarblocks28 >> ${RESULTS}/probBLOCKS-13-1.pddl
