...
src/search/downward --domain_name sokoban-opt08-strips --problem_name p12.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarsokoban-opt08-strips12 >> ${RESULTS}/p12.pddl
