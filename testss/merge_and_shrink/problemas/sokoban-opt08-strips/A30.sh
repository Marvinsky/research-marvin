...
src/search/downward --domain_name sokoban-opt08-strips --problem_name p30.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarsokoban-opt08-strips30 >> ${RESULTS}/p30.pddl
