...
src/search/downward --global_probes 1000 --domain_name sokoban-opt08-strips --problem_name p28.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarsokoban-opt08-strips28 >> ${RESULTS}/p28.pddl
