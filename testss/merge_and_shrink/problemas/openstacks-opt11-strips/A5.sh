...
src/search/downward --global_probes 1000 --domain_name openstacks-opt11-strips --problem_name p05.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astaropenstacks-opt11-strips5 >> ${RESULTS}/p05.pddl
