...
src/search/downward --global_probes 1000 --domain_name sokoban-opt11-strips --problem_name p17.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarsokoban-opt11-strips17 >> ${RESULTS}/p17.pddl
