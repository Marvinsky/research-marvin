...
src/search/downward --domain_name sokoban-opt11-strips --problem_name p06.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarsokoban-opt11-strips6 >> ${RESULTS}/p06.pddl
