...
src/search/downward --global_probes 1000 --domain_name sokoban-opt11-strips --problem_name p13.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarsokoban-opt11-strips13 >> ${RESULTS}/p13.pddl
