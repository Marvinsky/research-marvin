...
src/search/downward --domain_name transport-opt11-strips --problem_name p09.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astartransport-opt11-strips9 >> ${RESULTS}/p09.pddl
