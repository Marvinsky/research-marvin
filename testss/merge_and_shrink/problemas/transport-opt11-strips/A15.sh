...
src/search/downward --domain_name transport-opt11-strips --problem_name p15.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astartransport-opt11-strips15 >> ${RESULTS}/p15.pddl
