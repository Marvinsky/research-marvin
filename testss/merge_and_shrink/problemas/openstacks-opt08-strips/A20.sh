...
src/search/downward --global_probes 1000 --domain_name openstacks-opt08-strips --problem_name p20.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astaropenstacks-opt08-strips20 >> ${RESULTS}/p20.pddl
