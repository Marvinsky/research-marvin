...
src/search/downward --domain_name openstacks-opt08-strips --problem_name p14.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astaropenstacks-opt08-strips14 >> ${RESULTS}/p14.pddl
