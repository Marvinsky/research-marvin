...
src/search/downward --domain_name floortile-opt11-strips --problem_name opt-p08-015.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarfloortile-opt11-strips15 >> ${RESULTS}/opt-p08-015.pddl
