...
src/search/downward --domain_name floortile-opt11-strips --problem_name opt-p07-014.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarfloortile-opt11-strips14 >> ${RESULTS}/opt-p07-014.pddl
