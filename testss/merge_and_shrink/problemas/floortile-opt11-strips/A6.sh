...
src/search/downward --global_probes 1000 --domain_name floortile-opt11-strips --problem_name opt-p03-006.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarfloortile-opt11-strips6 >> ${RESULTS}/opt-p03-006.pddl
