...
src/search/downward --domain_name floortile-opt11-strips --problem_name opt-p06-012.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarfloortile-opt11-strips12 >> ${RESULTS}/opt-p06-012.pddl
