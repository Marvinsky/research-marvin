...
src/search/downward --domain_name woodworking-opt08-strips --problem_name p27.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarwoodworking-opt08-strips27 >> ${RESULTS}/p27.pddl
