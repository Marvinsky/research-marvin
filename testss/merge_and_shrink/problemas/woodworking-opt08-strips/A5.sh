...
src/search/downward --domain_name woodworking-opt08-strips --problem_name p05.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarwoodworking-opt08-strips5 >> ${RESULTS}/p05.pddl
