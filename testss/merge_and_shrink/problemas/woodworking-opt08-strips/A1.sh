...
src/search/downward --domain_name woodworking-opt08-strips --problem_name p01.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarwoodworking-opt08-strips1 >> ${RESULTS}/p01.pddl
