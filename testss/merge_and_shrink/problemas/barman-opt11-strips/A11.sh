...
src/search/downward --domain_name barman-opt11-strips --problem_name pfile03-011.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarbarman-opt11-strips11 >> ${RESULTS}/pfile03-011.pddl
