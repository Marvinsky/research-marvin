...
src/search/downward --domain_name barman-opt11-strips --problem_name pfile04-014.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarbarman-opt11-strips14 >> ${RESULTS}/pfile04-014.pddl
