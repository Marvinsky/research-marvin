...
src/search/downward --domain_name barman-opt11-strips --problem_name pfile02-008.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarbarman-opt11-strips8 >> ${RESULTS}/pfile02-008.pddl
