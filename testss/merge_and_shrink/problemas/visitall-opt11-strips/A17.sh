...
src/search/downward --domain_name visitall-opt11-strips --problem_name problem10-full.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarvisitall-opt11-strips17 >> ${RESULTS}/problem10-full.pddl
