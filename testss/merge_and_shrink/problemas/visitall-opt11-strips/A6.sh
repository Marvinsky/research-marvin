...
src/search/downward --global_probes 1000 --domain_name visitall-opt11-strips --problem_name problem04-half.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarvisitall-opt11-strips6 >> ${RESULTS}/problem04-half.pddl
