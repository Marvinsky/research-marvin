...
src/search/downward --global_probes 1000 --domain_name visitall-opt11-strips --problem_name problem09-half.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarvisitall-opt11-strips16 >> ${RESULTS}/problem09-half.pddl
