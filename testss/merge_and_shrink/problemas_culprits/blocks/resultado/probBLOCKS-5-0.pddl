...
Transition system (3/11 vars): init h=2, max f=10, max g=5, max h=5 [t=0.00s]
Next variable: 8
Transition system (3/11 vars): 72 states, ???/288 arcs, 7660 bytes
Transition system (3/11 vars): init h=2, max f=10, max g=5, max h=5 [t=0.00s]
...
Transition system (4/11 vars): init h=4, max f=14, max g=7, max h=7 [t=0.00s]
Next variable: 7
Transition system (4/11 vars): 432 states, ???/2268 arcs, 36860 bytes
Transition system (4/11 vars): init h=4, max f=14, max g=7, max h=7 [t=0.00s]
...
Transition system (6/11 vars): init h=8, max f=23, max g=18, max h=11 [t=0.02s]
Next variable: 4
Transition system (6/11 vars): 5184 states, ???/36504 arcs, 539628 bytes
Transition system (6/11 vars): init h=8, max f=23, max g=18, max h=11 [t=0.02s]
...
Transition system (7/11 vars): init h=8, max f=26, max g=18, max h=13 [t=0.04s]
Next variable: 3
Transition system (7/11 vars): 10368 states, ???/78624 arcs, 1143468 bytes
Transition system (7/11 vars): init h=8, max f=26, max g=18, max h=13 [t=0.04s]
Atomic transition system #3: 2 states, ???/5 arcs, 2908 bytes
Atomic transition system #3: init h=0, max f=1, max g=1, max h=0 [t=0.04s]
...
Transition system (7/11 vars): init h=8, max f=26, max g=18, max h=13 [t=0.05s]
...
Transition system (8/11 vars): init h=10, max f=28, max g=18, max h=15 [t=0.10s]
Next variable: 2
Transition system (8/11 vars): 20736 states, ???/168480 arcs, 2418620 bytes
Transition system (8/11 vars): init h=10, max f=28, max g=18, max h=15 [t=0.10s]
...
Transition system (9/11 vars): init h=10, max f=31, max g=18, max h=17 [t=0.19s]
Next variable: 1
...
Transition system (10/11 vars): init h=10, max f=31, max g=18, max h=17 [t=0.47s]
Next variable: 0
...
Transition system (10/11 vars): init h=10, max f=31, max g=18, max h=17 [t=0.53s]
...
Transition system (11/11 vars): init h=12, max f=36, max g=23, max h=20 [t=0.67s]
Transition system (11/11 vars): 42330 states, ???/312957 arcs, 5844656 bytes
Transition system (11/11 vars): init h=12, max f=36, max g=23, max h=20 [t=0.67s]
...
h_min: 12 depth: 0 #states: 0 time: 0.67s
	threshold: 12
...
totalPrediction : 23.00
bc: 1, cc: 62.21
count nodes generates : 64.28
count nodes expanded : 23.00
dominio = blocks
...
Actual search time: 0.28s [t=0.95s]
Search time: 0.95s
Total time: 0.95s
