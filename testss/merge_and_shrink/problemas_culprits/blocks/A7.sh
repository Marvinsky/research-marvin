...
src/search/downward-release --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-6-0.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarblocks7 >> ${RESULTS}/probBLOCKS-6-0.pddl
