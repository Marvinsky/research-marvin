...
src/search/downward-release --global_probes 1000 --domain_name blocks --problem_name probBLOCKS-4-0.pddl --heuristic_name merge_and_shrink --search "ss(merge_and_shrink())" <  Astarblocks1 >> ${RESULTS}/probBLOCKS-4-0.pddl
