...
ScalarEvaluator vector pointer after add g = [0xa41bb68]
ScalarEvaluator vector pointer after add eval = [0xa41bb68, 0xa4224c0]
subevaluators_.size:2
new vector of ScalarEvaluator created = [0xa42ad30, 0xa4224c0]
OpenList vector of state_var_t objects = 0xa43b558
engine = 0xa4275c8
...
starting timings 
initial state = 0xa3de518
node_counter = 161119
node_gen_and_exp_cost = 6,26866e-06
...
h[,0,] is:,,regular_lm_cut,measured time cost: 0,000336391,h:22
memory before deleting databases: 
VmRSS memory: 17004 KB
