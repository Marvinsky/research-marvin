...
ScalarEvaluator vector pointer after add g = [0x8cdfa28]
ScalarEvaluator vector pointer after add eval = [0x8cdfa28, 0x8cc0c48]
subevaluators_.size:2
new vector of ScalarEvaluator created = [0x8cddf90, 0x8cc0c48]
OpenList vector of state_var_t objects = 0x8ce0830
engine = 0x8ccce60
...
starting timings 
initial state = 0x8c84518
node_counter = 305612
node_gen_and_exp_cost = 3,30484e-06
...
h[,0,] is:,,regular_lm_cut,measured time cost: 0,000164179,h:22
memory before deleting databases: 
VmRSS memory: 29540 KB
...
fileName size () = 1
fileName size () = 2
Path in the ss = probBLOCKS-12-0.pddl
the directory was not created.
rutaR = /home/marvin/marvin/test/lmcut/report/blocks/probBLOCKS-12-0.pddl
titulo = /home/marvin/marvin/test/lmcut/problemas/blocks/resultado/probBLOCKS-12-0.pddl
...
counter k = 2
 _____________________________________________________________________
|   # of nodes expanded by ss at level 23 is :     4                |
 _____________________________________________________________________
depth = 24
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
counter k = 3
 _____________________________________________________________________
|   # of nodes expanded by ss at level 24 is :     16                |
 _____________________________________________________________________
depth = 25
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
counter k = 4
 _____________________________________________________________________
|   # of nodes expanded by ss at level 25 is :     52                |
 _____________________________________________________________________
depth = 26
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
g = 4
f-value generated at 4 level.
23, 23, 23, 24, 24, 24, 24, 25, 25, 25, 26, 26, 26, 26, 
g = 5
...
counter k = 5
 _____________________________________________________________________
|   # of nodes expanded by ss at level 26 is :     196                |
 _____________________________________________________________________
depth = 27
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
g = 5
f-value generated at 5 level.
23, 23, 23, 24, 24, 24, 24, 25, 25, 25, 26, 26, 26, 26, 27, 27, 27, 
g = 6
...
counter k = 6
 _____________________________________________________________________
|   # of nodes expanded by ss at level 27 is :     628                |
 _____________________________________________________________________
depth = 28
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
g = 6
f-value generated at 6 level.
23, 23, 23, 24, 24, 24, 24, 25, 25, 25, 26, 26, 26, 26, 27, 27, 27, 28, 28, 28, 28, 
g = 7
...
counter k = 7
 _____________________________________________________________________
|   # of nodes expanded by ss at level 28 is :     2356                |
 _____________________________________________________________________
depth = 29
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
g = 7
f-value generated at 7 level.
23, 23, 23, 24, 24, 24, 24, 25, 25, 25, 26, 26, 26, 26, 27, 27, 27, 28, 28, 28, 28, 29, 29, 29, 
g = 8
...
counter k = 8
 _____________________________________________________________________
|   # of nodes expanded by ss at level 29 is :     7540                |
 _____________________________________________________________________
depth = 30
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
g = 8
f-value generated at 8 level.
23, 23, 23, 24, 24, 24, 24, 25, 25, 25, 26, 26, 26, 26, 27, 27, 27, 28, 28, 28, 28, 29, 29, 29, 30, 30, 30, 30, 
g = 9
...
counter k = 9
 _____________________________________________________________________
|   # of nodes expanded by ss at level 30 is :     28276                |
 _____________________________________________________________________
depth = 31
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
g = 9
f-value generated at 9 level.
23, 23, 23, 24, 24, 24, 24, 25, 25, 25, 26, 26, 26, 26, 27, 27, 27, 28, 28, 28, 28, 29, 29, 29, 30, 30, 30, 30, 31, 31, 31, 
g = 10
...
counter k = 10
 _____________________________________________________________________
|   # of nodes expanded by ss at level 31 is :     90484                |
 _____________________________________________________________________
depth = 32
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
g = 10
f-value generated at 10 level.
23, 23, 23, 24, 24, 24, 24, 25, 25, 25, 26, 26, 26, 26, 27, 27, 27, 28, 28, 28, 28, 29, 29, 29, 30, 30, 30, 30, 31, 31, 31, 32, 32, 32, 32, 
g = 11
...
counter k = 11
 _____________________________________________________________________
|   # of nodes expanded by ss at level 32 is :     339316                |
 _____________________________________________________________________
depth = 33
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
g = 11
f-value generated at 11 level.
23, 23, 23, 24, 24, 24, 24, 25, 25, 25, 26, 26, 26, 26, 27, 27, 27, 28, 28, 28, 28, 29, 29, 29, 30, 30, 30, 30, 31, 31, 31, 32, 32, 32, 32, 33, 33, 33, 
g = 12
...
counter k = 12
 _____________________________________________________________________
|   # of nodes expanded by ss at level 33 is :     1085812                |
 _____________________________________________________________________
depth = 34
heuristic value of te initial node based on the heuristic vector = 22
heuristic value of the initial node based on the node = 22
...
g = 12
f-value generated at 12 level.
23, 23, 23, 24, 24, 24, 24, 25, 25, 25, 26, 26, 26, 26, 27, 27, 27, 28, 28, 28, 28, 29, 29, 29, 30, 30, 30, 30, 31, 31, 31, 32, 32, 32, 32, 33, 33, 33, 34, 34, 34, 34, 
g = 13
...
counter k = 13
 _____________________________________________________________________
|   # of nodes expanded by ss at level 34 is :     4071796                |
 _____________________________________________________________________
the directory was not created
