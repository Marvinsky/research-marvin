...
Atomic transition system #10: init h=0, max f=4, max g=2, max h=2 [t=0.00s]
...
Transition system (2/11 vars): init h=0, max f=6, max g=3, max h=3 [t=0.00s]
Next variable: 9
Transition system (2/11 vars): 12 states, ???/33 arcs, 3664 bytes
Transition system (2/11 vars): init h=0, max f=6, max g=3, max h=3 [t=0.00s]
...
Atomic transition system #9: 6 states, ???/16 arcs, 3328 bytes
Atomic transition system #9: init h=2, max f=4, max g=2, max h=2 [t=0.01s]
Transition system (2/11 vars): 12 states, ???/33 arcs, 3664 bytes
Transition system (2/11 vars): init h=0, max f=6, max g=3, max h=3 [t=0.01s]
...
Transition system (3/11 vars): init h=2, max f=10, max g=5, max h=5 [t=0.01s]
Next variable: 8
Transition system (3/11 vars): 72 states, ???/288 arcs, 7660 bytes
Transition system (3/11 vars): init h=2, max f=10, max g=5, max h=5 [t=0.01s]
...
Transition system (5/11 vars): init h=6, max f=18, max g=9, max h=9 [t=0.01s]
Next variable: 5
Transition system (5/11 vars): 2592 states, ???/16848 arcs, 244220 bytes
Transition system (5/11 vars): init h=6, max f=18, max g=9, max h=9 [t=0.01s]
...
Transition system (6/11 vars): init h=8, max f=23, max g=18, max h=11 [t=0.03s]
Next variable: 4
Transition system (6/11 vars): 5184 states, ???/36504 arcs, 539628 bytes
Transition system (6/11 vars): init h=8, max f=23, max g=18, max h=11 [t=0.03s]
...
Transition system (6/11 vars): init h=8, max f=23, max g=18, max h=11 [t=0.04s]
...
Transition system (7/11 vars): init h=8, max f=26, max g=18, max h=13 [t=0.06s]
Next variable: 3
Transition system (7/11 vars): 10368 states, ???/78624 arcs, 1143468 bytes
Transition system (7/11 vars): init h=8, max f=26, max g=18, max h=13 [t=0.06s]
...
Transition system (7/11 vars): init h=8, max f=26, max g=18, max h=13 [t=0.07s]
...
Transition system (9/11 vars): init h=10, max f=31, max g=18, max h=17 [t=0.25s]
Next variable: 1
...
Transition system (9/11 vars): 25000 states, ???/269076 arcs, 7229004 bytes
...
Transition system (9/11 vars): 25000 states, ???/264854 arcs, 6212624 bytes
Transition system (9/11 vars): init h=10, max f=31, max g=18, max h=17 [t=0.38s]
...
Transition system (10/11 vars): 41289 states, ???/390119 arcs, 7952244 bytes
...
Transition system (10/11 vars): 8333 states, ???/103757 arcs, 7655636 bytes
...
Transition system (11/11 vars): unreachable: 7454 states, irrelevant: 214 states
Transition system (11/11 vars): applying abstraction (49998 to 42330 states)
Transition system (11/11 vars): applying abstraction to lookup table
Transition system (11/11 vars): 42330 states, ???/312957 arcs, 5844656 bytes
Transition system (11/11 vars): init h=12, max f=36, max g=23, max h=20 [t=0.87s]
Transition system (11/11 vars): 42330 states, ???/312957 arcs, 5844656 bytes
Transition system (11/11 vars): init h=12, max f=36, max g=23, max h=20 [t=0.87s]
Order of merged transition systems: 10 6, 11 9, 12 8, 13 7, 14 5, 15 4, 16 3, 17 2, 18 1, 19 0, 
Done initializing merge-and-shrink heuristic [0.87s]
initial h value: 12
Estimated peak memory for transition system: 5844656 bytes
calling evaluate
f = 12 [1 evaluated, 0 expanded, t=0.87s, 18648 KB,generated_states:,0,dead_end_states:0,Dup States:-1,]
Best heuristic value: 12 [g=0, 1 evaluated, 0 expanded, t=0.87s, 18648 KB]
h_initial = 12
end expansion of nodes finished.
Total of nodes expanded: 24.00
Total of nodes generated: 64.00
collector.size() = 13
changing the code.
dominio = blocks
...
fdist created.
outputFile = /home/marvin/marvin/testdfs/merge_and_shrink/reportdfs/blocks/fdist/probBLOCKS-5-0.pddl
g:0
size: 1
	f: 12	q: 2.00
...
Actual search time: 0.01s [t=0.88s]
