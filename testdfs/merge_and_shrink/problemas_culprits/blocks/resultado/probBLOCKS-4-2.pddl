...
Transition system (5/9 vars): init h=6, max f=17, max g=12, max h=9 [t=0.01s]
Next variable: 3
Transition system (5/9 vars): 500 states, ???/2850 arcs, 45756 bytes
Transition system (5/9 vars): init h=6, max f=17, max g=12, max h=9 [t=0.01s]
...
Transition system (6/9 vars): init h=6, max f=20, max g=12, max h=11 [t=0.01s]
Next variable: 2
Transition system (6/9 vars): 1000 states, ???/6300 arcs, 96604 bytes
Transition system (6/9 vars): init h=6, max f=20, max g=12, max h=11 [t=0.01s]
...
Transition system (7/9 vars): init h=6, max f=23, max g=12, max h=13 [t=0.02s]
Next variable: 1
Transition system (7/9 vars): 2000 states, ???/13800 arcs, 205516 bytes
Transition system (7/9 vars): init h=6, max f=23, max g=12, max h=13 [t=0.02s]
...
Transition system (8/9 vars): init h=6, max f=23, max g=13, max h=13 [t=0.03s]
Next variable: 0
Transition system (8/9 vars): 2984 states, ???/18576 arcs, 363628 bytes
Transition system (8/9 vars): init h=6, max f=23, max g=13, max h=13 [t=0.03s]
...
Transition system (9/9 vars): init h=6, max f=20, max g=8, max h=12 [t=0.05s]
Transition system (9/9 vars): 125 states, ???/272 arcs, 102452 bytes
Transition system (9/9 vars): init h=6, max f=20, max g=8, max h=12 [t=0.05s]
Order of merged transition systems: 8 5, 9 7, 10 6, 11 4, 12 3, 13 2, 14 1, 15 0, 
Done initializing merge-and-shrink heuristic [0.05s]
initial h value: 6
Estimated peak memory for transition system: 102452 bytes
calling evaluate
f = 6 [1 evaluated, 0 expanded, t=0.05s, 4524 KB,generated_states:,0,dead_end_states:0,Dup States:-1,]
Best heuristic value: 6 [g=0, 1 evaluated, 0 expanded, t=0.05s, 4524 KB]
h_initial = 6
end expansion of nodes finished.
Total of nodes expanded: 5320.00
Total of nodes generated: 12318.00
collector.size() = 34
changing the code.
dominio = blocks
...
fdist created.
outputFile = /home/marvin/marvin/testdfs/merge_and_shrink/reportdfs/blocks/fdist/probBLOCKS-4-2.pddl
g:0
size: 1
	f: 6	q: 3.00
...
Actual search time: 0.02s [t=0.07s]
Initial state h value: 6.
Expanded 0 state(s).
Reopened 0 state(s).
Evaluated 1 state(s).
Evaluations: 1
Generated 12318 state(s).
Dead ends: 0 state(s).
