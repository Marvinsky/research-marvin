...
ScalarEvaluator vector pointer after add g = [0x8a58860]
ScalarEvaluator vector pointer after add eval = [0x8a58860, 0x8a52ad8]
subevaluators_.size:2
new vector of ScalarEvaluator created = [0x8a54490, 0x8a52ad8]
OpenList vector of state_var_t objects = 0x8a52b28
engine = 0x8a598e8
...
starting timings 
initial state = 0x8a47cb0
node_counter = 565806
node_gen_and_exp_cost = 1,76739e-06
...
Abstraction (8/11 vars): init h=10, max f=28, max g=18, max h=15 [t=1,11s]
...
Abstraction (9/11 vars): distances not computed [t=1,11s]
Next variable: #1
...
Abstraction (9/11 vars): 25000 states, ???/264860 arcs, 3458788 bytes
...
Abstraction (10/11 vars): 50000 states, ???/435906 arcs, 4038260 bytes
Abstraction (10/11 vars): distances not computed [t=1,21s]
Next variable: #0
...
Abstraction (10/11 vars): 8333 states, ???/390131 arcs, 3697060 bytes
Abstraction (10/11 vars): init h=10, max f=31, max g=18, max h=17 [t=1,27s]
Atomic abstraction #0: 6 states, ???/10 arcs, 984 bytes
Atomic abstraction #0: init h=0, max f=2, max g=2, max h=0 [t=1,27s]
...
Abstraction (10/11 vars): init h=10, max f=31, max g=18, max h=17 [t=1,29s]
Atomic abstraction #0: normalizing without label reduction
Atomic abstraction #0: 6 states, ???/10 arcs, 984 bytes
Atomic abstraction #0: init h=0, max f=2, max g=2, max h=0 [t=1,29s]
Merging abstraction (10/11 vars) and atomic abstraction #0
Abstraction (11/11 vars): 49998 states, ???/312074 arcs, 2847592 bytes
Abstraction (11/11 vars): distances not computed [t=1,3s]
Abstraction (11/11 vars): computing distances using unit-cost algorithm
Abstraction (11/11 vars): unreachable: 7424 states, irrelevant: 214 states
Abstraction (11/11 vars): shrink forced to prune unreachable/irrelevant states
Abstraction (11/11 vars): applying abstraction (49998 to 42360 states)
Abstraction (11/11 vars): applying abstraction to lookup table
Abstraction (11/11 vars): size after shrink 42360, target 49998
Abstraction (11/11 vars): shrink forced to prune unreachable/irrelevant states
Abstraction (11/11 vars): applying abstraction (42360 to 42360 states)
Abstraction (11/11 vars): applying abstraction to lookup table
Abstraction (11/11 vars): size after shrink 42360, target 42360
Abstraction (11/11 vars): distances already known
Abstraction (11/11 vars): 42360 states, ???/296346 arcs, 3053000 bytes
Abstraction (11/11 vars): init h=12, max f=36, max g=23, max h=20 [t=1,34s]
Done initializing merge-and-shrink heuristic [0,34s]
initial h value: 12
Estimated peak memory for abstraction: 3053000 bytes
heur_name = No Name
h[,0,] is:,heur is not named,measured time cost: 0,34,h:12
memory before deleting databases: 
VmRSS memory: 23996 KB
