...
ScalarEvaluator vector pointer after add g = [0x9319c00]
ScalarEvaluator vector pointer after add eval = [0x9319c00, 0x931a3e8]
subevaluators_.size:2
new vector of ScalarEvaluator created = [0x931be70, 0x931a3e8]
OpenList vector of state_var_t objects = 0x931c5c0
engine = 0x931b958
...
starting timings 
initial state = 0x93130f8
node_counter = 393867
node_gen_and_exp_cost = 2,53893e-06
...
heur_name = No Name
h[,0,] is:,heur is not named,measured time cost: 1,71236e-06,h:10
memory before deleting databases: 
VmRSS memory: 9488 KB
...
VmRSS memory: 1880 KB
VmHWM memory: 10120 KB
