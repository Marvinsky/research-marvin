...
ScalarEvaluator vector pointer after add g = [0x947fff8]
ScalarEvaluator vector pointer after add eval = [0x947fff8, 0x9482420]
subevaluators_.size:2
new vector of ScalarEvaluator created = [0x9481e40, 0x9482420]
OpenList vector of state_var_t objects = 0x9481318
engine = 0x94813a0
...
starting timings 
initial state = 0x94790f8
node_counter = 389258
node_gen_and_exp_cost = 2,56899e-06
...
F_bound:,1650551918,Peak memory=,18,2734
				h = -2
				best_h = -1
				new best_h = -2
...
heur_name = No Name
h[,0,] is:,heur is not named,measured time cost: 1,47325e-06,h:6
memory before deleting databases: 
VmRSS memory: 9400 KB
