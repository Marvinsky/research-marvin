...
src/search/downward --global_probes 100 --domain_name blocks --problem_name probBLOCKS-10-0.pddl --heuristic_name ipdb  --search "dfs(ipdb())" <  Astarblocks19 >> ${RESULTS}/probBLOCKS-10-0.pddl
