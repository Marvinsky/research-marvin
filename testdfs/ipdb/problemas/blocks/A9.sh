...
src/search/downward --global_probes 100 --domain_name blocks --problem_name probBLOCKS-6-2.pddl --heuristic_name ipdb  --search "dfs(ipdb())" <  Astarblocks9 >> ${RESULTS}/probBLOCKS-6-2.pddl
