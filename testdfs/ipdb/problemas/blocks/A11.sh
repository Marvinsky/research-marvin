...
src/search/downward --global_probes 100 --domain_name blocks --problem_name probBLOCKS-7-1.pddl --heuristic_name ipdb  --search "dfs(ipdb())" <  Astarblocks11 >> ${RESULTS}/probBLOCKS-7-1.pddl
