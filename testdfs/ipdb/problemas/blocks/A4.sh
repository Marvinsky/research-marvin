...
src/search/downward --global_probes 100 --domain_name blocks --problem_name probBLOCKS-5-0.pddl --heuristic_name ipdb  --search "dfs(ipdb())" <  Astarblocks4 >> ${RESULTS}/probBLOCKS-5-0.pddl
