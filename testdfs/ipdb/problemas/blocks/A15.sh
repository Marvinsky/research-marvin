...
src/search/downward --global_probes 100 --domain_name blocks --problem_name probBLOCKS-8-2.pddl --heuristic_name ipdb  --search "dfs(ipdb())" <  Astarblocks15 >> ${RESULTS}/probBLOCKS-8-2.pddl
