...
src/search/downward --global_probes 100 --domain_name blocks --problem_name probBLOCKS-15-0.pddl --heuristic_name ipdb  --search "dfs(ipdb())" <  Astarblocks31 >> ${RESULTS}/probBLOCKS-15-0.pddl
