...
src/search/downward --global_probes 100 --domain_name blocks --problem_name probBLOCKS-16-2.pddl --heuristic_name ipdb  --search "dfs(ipdb())" <  Astarblocks34 >> ${RESULTS}/probBLOCKS-16-2.pddl
