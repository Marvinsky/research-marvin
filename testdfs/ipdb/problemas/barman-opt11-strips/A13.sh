...
src/search/downward-release --domain_name barman-opt11-strips --problem_name pfile04-013.pddl --heuristic_name ipdb --search "dfs(ipdb())" <  Astarbarman-opt11-strips13 > ${RESULTS}/pfile04-013.pddl
