...
src/search/downward-release --domain_name barman-opt11-strips --problem_name pfile02-008.pddl --heuristic_name ipdb --search "dfs(ipdb())" <  Astarbarman-opt11-strips8 > ${RESULTS}/pfile02-008.pddl
