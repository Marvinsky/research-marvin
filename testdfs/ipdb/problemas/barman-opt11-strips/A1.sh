...
RESULTS=/home/marvin/marvin/testdfs/ipdb/problemas/barman-opt11-strips/resultado
...
src/search/downward-release --global_probes 100 --domain_name barman-opt11-strips --problem_name pfile03-010.pddl --heuristic_name ipdb  --search "dfs(ipdb())" <  Astarbarman-opt11-strips1 > ${RESULTS}/pfile03-010.pddl
