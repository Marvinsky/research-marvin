...
src/search/downward-release --domain_name barman-opt11-strips --problem_name pfile04-015.pddl --heuristic_name ipdb --search "dfs(ipdb())" <  Astarbarman-opt11-strips15 > ${RESULTS}/pfile04-015.pddl
