...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-14-1.pddl --heuristic_name ipdb  --search "dfs_culprits(ipdb())" <  Astarblocks30 >> ${RESULTS}/probBLOCKS-14-1.pddl
