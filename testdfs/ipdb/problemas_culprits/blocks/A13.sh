...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-8-0.pddl --heuristic_name ipdb  --search "dfs_culprits(ipdb())" <  Astarblocks13 >> ${RESULTS}/probBLOCKS-8-0.pddl
