...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-10-1.pddl --heuristic_name ipdb  --search "dfs_culprits(ipdb())" <  Astarblocks20 >> ${RESULTS}/probBLOCKS-10-1.pddl
