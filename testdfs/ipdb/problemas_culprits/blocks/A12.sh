...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-7-2.pddl --heuristic_name ipdb  --search "dfs_culprits(ipdb())" <  Astarblocks12 >> ${RESULTS}/probBLOCKS-7-2.pddl
