...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-8-2.pddl --heuristic_name ipdb  --search "dfs_culprits(ipdb())" <  Astarblocks15 >> ${RESULTS}/probBLOCKS-8-2.pddl
