...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-13-0.pddl --heuristic_name ipdb  --search "dfs_culprits(ipdb())" <  Astarblocks27 >> ${RESULTS}/probBLOCKS-13-0.pddl
