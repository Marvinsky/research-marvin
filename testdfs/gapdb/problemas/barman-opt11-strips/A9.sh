...
src/search/downward-release --global_probes 100 --domain_name barman-opt11-strips --problem_name pfile03-009.pddl --heuristic_name gapdb --use_saved_pdbs  --search "dfs_culprits(max([gapdb(mp=0.5)]))" <  Astarbarman-opt11-strips9 >> ${RESULTS}/pfile03-009.pddl
