...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-6-1.pddl --heuristic_name gapdb  --search "dfs_culprits(gapdb(mp=0.5))" <  Astarblocks8 >> ${RESULTS}/probBLOCKS-6-1.pddl
