...
src/search/downward-release --global_probes 100 --domain_name barman-opt11-strips --problem_name pfile02-007.pddl --heuristic_name hmax  --search "dfs_culprits(hmax())" <  Astarbarman-opt11-strips7 >> ${RESULTS}/pfile02-007.pddl
