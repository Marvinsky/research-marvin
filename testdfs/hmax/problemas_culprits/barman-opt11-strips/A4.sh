...
src/search/downward-release --global_probes 100 --domain_name barman-opt11-strips --problem_name pfile01-004.pddl --heuristic_name hmax  --search "dfs_culprits(hmax())" <  Astarbarman-opt11-strips4 >> ${RESULTS}/pfile01-004.pddl
