...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-16-2.pddl --heuristic_name hmax  --search "dfs_culprits(hmax())" <  Astarblocks34 >> ${RESULTS}/probBLOCKS-16-2.pddl
