...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-5-2.pddl --heuristic_name hmax  --search "dfs_culprits(hmax())" <  Astarblocks6 >> ${RESULTS}/probBLOCKS-5-2.pddl
