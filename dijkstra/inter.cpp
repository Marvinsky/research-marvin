...
void create_report2(string dijkstraText, string fileName, string pasta, string heuristic, string astarText) {
	...
	output = "dijkstra/"+heuristic+"/reportdijkstra/"+output;
	...
	output2 = "dijkstra/"+heuristic+"/reportdijkstra/"+output2;
...
void create_report1(string heuristic, int countProblems, string aux_heuristic) {
	...
	do {
		...
		string  pastaReporte = "mkdir /home/marvin/marvin/dijkstra/"+heuristic+"/reportdijkstra/"+pasta;
		system(pastaReporte.c_str());     

		
	        string  pastaInterpolar2 = "mkdir /home/marvin/marvin/dijkstra/"+heuristic+"/reportdijkstra/"+pasta+"/interpolar2";
		system(pastaInterpolar2.c_str());     
		
	
	        string  pastaInterpolar3 = "mkdir /home/marvin/marvin/dijkstra/"+heuristic+"/reportdijkstra/"+pasta+"/interpolar3";
		system(pastaInterpolar3.c_str());     
 
        	string output;
        	output = "resultado/";
        	output =  pasta+"/"+output;
		output = "dijkstra/"+heuristic+"/problemas/"+output;
		output = "marvin/" + output;
		output = "marvin/" + output;
		output = "/home/" + output;	
		//cout<<output.c_str()<<endl; 
		...
		output7 = "astar/"+aux_heuristic+"/reportastar/"+output7;
