...
# heuristics:1
starting timings
node gen_and_exp_cost:1.45438e-06
...
h[,0,] is:,,heur:blind,measured time cost:5.24102e-07,h:1
memory before deleting databases:
VmRSS memory: 16092 KB
...
nodesGeneratedByLevel: 14
 time0: 1.11
nodesGeneratedToTheLevel: 214
f: 7 [108 evaluated, 102 expanded, t=1.11s,generated_states:,214,additional_states:,14,],random_comb_index:-1
last_jump:7,F_bound_to_print:0
gen_to_exp_ratio: 0.56
F_bound:,7,Peak memory=,30.2031
F:7
F_bound:7,Peak memory=30.2031,nodes:108,Nodes mem_space:3.375,F_boundary_Range:5
F:7
F_bound:7F_boundary_time:-9.76866e-17,Hoff Potential Range:5,leaves_to_sample:5
