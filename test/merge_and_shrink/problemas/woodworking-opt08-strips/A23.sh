#PBS -N merge_and_shrink_d19_p23
...
src/search/downward --domain_name woodworking-opt08-strips --problem_name p23.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarwoodworking-opt08-strips23 >> ${RESULTS}/p23.pddl
