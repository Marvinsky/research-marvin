...
src/search/downward --domain_name woodworking-opt08-strips --problem_name p30.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarwoodworking-opt08-strips30 >> ${RESULTS}/p30.pddl
