...
src/search/downward --domain_name woodworking-opt08-strips --problem_name p24.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarwoodworking-opt08-strips24 >> ${RESULTS}/p24.pddl
