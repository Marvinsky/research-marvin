...
src/search/downward --domain_name elevators-opt08-strips --problem_name p07.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarelevators-opt08-strips7 >> ${RESULTS}/p07.pddl
