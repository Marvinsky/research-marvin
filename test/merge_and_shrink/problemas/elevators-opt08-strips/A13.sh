...
src/search/downward --domain_name elevators-opt08-strips --problem_name p13.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarelevators-opt08-strips13 >> ${RESULTS}/p13.pddl
