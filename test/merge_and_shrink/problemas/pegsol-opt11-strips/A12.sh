#PBS -N merge_and_shrink_d11_p12
...
src/search/downward --domain_name pegsol-opt11-strips --problem_name p12.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarpegsol-opt11-strips12 >> ${RESULTS}/p12.pddl
