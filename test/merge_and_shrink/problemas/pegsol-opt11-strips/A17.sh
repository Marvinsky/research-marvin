#PBS -N merge_and_shrink_d11_p17
...
src/search/downward --domain_name pegsol-opt11-strips --problem_name p17.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarpegsol-opt11-strips17 >> ${RESULTS}/p17.pddl
