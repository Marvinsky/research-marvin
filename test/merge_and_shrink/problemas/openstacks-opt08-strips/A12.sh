...
src/search/downward --domain_name openstacks-opt08-strips --problem_name p12.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astaropenstacks-opt08-strips12 >> ${RESULTS}/p12.pddl
