...
src/search/downward --domain_name openstacks-opt08-strips --problem_name p19.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astaropenstacks-opt08-strips19 >> ${RESULTS}/p19.pddl
