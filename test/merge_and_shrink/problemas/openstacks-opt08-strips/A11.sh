...
src/search/downward --domain_name openstacks-opt08-strips --problem_name p11.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astaropenstacks-opt08-strips11 >> ${RESULTS}/p11.pddl
