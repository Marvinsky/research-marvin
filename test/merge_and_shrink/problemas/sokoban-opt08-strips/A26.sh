...
src/search/downward --domain_name sokoban-opt08-strips --problem_name p26.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarsokoban-opt08-strips26 >> ${RESULTS}/p26.pddl
