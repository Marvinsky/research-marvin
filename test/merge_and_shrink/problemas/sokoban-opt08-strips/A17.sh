#PBS -N merge_and_shrink_d13_p17
...
src/search/downward --domain_name sokoban-opt08-strips --problem_name p17.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarsokoban-opt08-strips17 >> ${RESULTS}/p17.pddl
