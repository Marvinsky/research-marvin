#PBS -N merge_and_shrink_d13_p29
...
src/search/downward --domain_name sokoban-opt08-strips --problem_name p29.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarsokoban-opt08-strips29 >> ${RESULTS}/p29.pddl
