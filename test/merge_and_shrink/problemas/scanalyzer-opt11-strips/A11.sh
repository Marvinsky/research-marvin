...
src/search/downward --domain_name scanalyzer-opt11-strips --problem_name p11.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarscanalyzer-opt11-strips11 >> ${RESULTS}/p11.pddl
