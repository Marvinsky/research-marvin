...
src/search/downward --domain_name nomystery-opt11-strips --problem_name p18.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarnomystery-opt11-strips18 >> ${RESULTS}/p18.pddl
