...
src/search/downward --domain_name elevators-opt11-strips --problem_name p08.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarelevators-opt11-strips8 >> ${RESULTS}/p08.pddl
