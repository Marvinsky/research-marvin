...
src/search/downward --domain_name woodworking-opt11-strips --problem_name p02.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarwoodworking-opt11-strips2 >> ${RESULTS}/p02.pddl
