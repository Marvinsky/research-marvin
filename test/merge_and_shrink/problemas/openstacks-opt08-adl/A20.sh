...
src/search/downward --domain_name openstacks-opt08-adl --problem_name p20.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astaropenstacks-opt08-adl20 >> ${RESULTS}/p20.pddl
