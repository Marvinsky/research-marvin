...
src/search/downward --domain_name openstacks-opt08-adl --problem_name p02.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astaropenstacks-opt08-adl2 >> ${RESULTS}/p02.pddl
