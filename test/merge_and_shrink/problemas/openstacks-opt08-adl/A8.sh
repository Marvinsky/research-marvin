...
src/search/downward --domain_name openstacks-opt08-adl --problem_name p08.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astaropenstacks-opt08-adl8 >> ${RESULTS}/p08.pddl
