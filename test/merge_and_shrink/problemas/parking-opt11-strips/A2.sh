...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile03-012.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarparking-opt11-strips2 >> ${RESULTS}/pfile03-012.pddl
