...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile07-027.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarparking-opt11-strips17 >> ${RESULTS}/pfile07-027.pddl
