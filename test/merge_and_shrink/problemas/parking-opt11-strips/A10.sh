...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile05-020.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarparking-opt11-strips10 >> ${RESULTS}/pfile05-020.pddl
