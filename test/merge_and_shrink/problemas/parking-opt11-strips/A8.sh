...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile05-018.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarparking-opt11-strips8 >> ${RESULTS}/pfile05-018.pddl
