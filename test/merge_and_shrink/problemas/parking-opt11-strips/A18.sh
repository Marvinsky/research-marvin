...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile07-028.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarparking-opt11-strips18 >> ${RESULTS}/pfile07-028.pddl
