...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile05-019.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarparking-opt11-strips9 >> ${RESULTS}/pfile05-019.pddl
