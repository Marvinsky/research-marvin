...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile06-023.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarparking-opt11-strips13 >> ${RESULTS}/pfile06-023.pddl
