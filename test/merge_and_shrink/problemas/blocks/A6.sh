...
src/search/downward --domain_name blocks --problem_name probBLOCKS-5-2.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks6 >> ${RESULTS}/probBLOCKS-5-2.pddl
