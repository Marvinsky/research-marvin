...
src/search/downward --domain_name blocks --problem_name probBLOCKS-15-1.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks32 >> ${RESULTS}/probBLOCKS-15-1.pddl
