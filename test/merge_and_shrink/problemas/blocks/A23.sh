#PBS -N merge_and_shrink_d21_p23
...
src/search/downward --domain_name blocks --problem_name probBLOCKS-11-1.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks23 >> ${RESULTS}/probBLOCKS-11-1.pddl
