...
src/search/downward --domain_name blocks --problem_name probBLOCKS-10-0.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks19 >> ${RESULTS}/probBLOCKS-10-0.pddl
