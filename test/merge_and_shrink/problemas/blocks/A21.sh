#PBS -N merge_and_shrink_d21_p21
...
src/search/downward --domain_name blocks --problem_name probBLOCKS-10-2.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks21 >> ${RESULTS}/probBLOCKS-10-2.pddl
