...
src/search/downward --domain_name blocks --problem_name probBLOCKS-14-1.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks30 >> ${RESULTS}/probBLOCKS-14-1.pddl
