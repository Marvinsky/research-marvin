#PBS -N merge_and_shrink_d21_p27
...
src/search/downward --domain_name blocks --problem_name probBLOCKS-13-0.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks27 >> ${RESULTS}/probBLOCKS-13-0.pddl
