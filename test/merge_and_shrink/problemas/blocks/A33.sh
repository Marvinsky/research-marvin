...
src/search/downward --domain_name blocks --problem_name probBLOCKS-16-0.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks33 >> ${RESULTS}/probBLOCKS-16-0.pddl
