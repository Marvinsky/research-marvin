...
src/search/downward --domain_name blocks --problem_name probBLOCKS-8-0.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks13 >> ${RESULTS}/probBLOCKS-8-0.pddl
