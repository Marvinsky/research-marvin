...
src/search/downward --domain_name blocks --problem_name probBLOCKS-8-1.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks14 >> ${RESULTS}/probBLOCKS-8-1.pddl
