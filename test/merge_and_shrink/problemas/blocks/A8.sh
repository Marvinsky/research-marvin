...
src/search/downward --domain_name blocks --problem_name probBLOCKS-6-1.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks8 >> ${RESULTS}/probBLOCKS-6-1.pddl
