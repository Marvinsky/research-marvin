...
# heuristics:1
starting timings
node gen_and_exp_cost:2.66483e-06
...
h[,0,] is:,heur is not named,measured time cost:1.11992e-06,h:6
memory before deleting databases:
VmRSS memory: 9500 KB
...
F:8
F_bound:8,Peak memory=19.582,nodes:14,Nodes mem_space:0.546875,F_boundary_Range:6
F:8
