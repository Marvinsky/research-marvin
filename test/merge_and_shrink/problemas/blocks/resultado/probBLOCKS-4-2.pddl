...
# heuristics:1
starting timings
node gen_and_exp_cost:1.40436e-06
...
h[,0,] is:,heur is not named,measured time cost:7.28689e-07,h:6
memory before deleting databases:
VmRSS memory: 16840 KB
...
|          Solution found!        |
 _________________________________
overall generated nodes to last iter:,17,search_time:,1.13,overall time:,1.13
totalniveles: 1
v_f.size() = 17
v_g.size() = 7
totallevels: 6
...
VmRSS memory: 1824 KB
VmHWM memory: 18060 KB
