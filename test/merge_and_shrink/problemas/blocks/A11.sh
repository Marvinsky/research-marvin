#PBS -N merge_and_shrink_d21_p11
...
src/search/downward --domain_name blocks --problem_name probBLOCKS-7-1.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarblocks11 >> ${RESULTS}/probBLOCKS-7-1.pddl
