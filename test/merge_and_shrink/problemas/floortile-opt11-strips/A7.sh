...
src/search/downward --domain_name floortile-opt11-strips --problem_name opt-p04-007.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarfloortile-opt11-strips7 >> ${RESULTS}/opt-p04-007.pddl
