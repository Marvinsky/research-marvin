...
src/search/downward --domain_name floortile-opt11-strips --problem_name opt-p01-001.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarfloortile-opt11-strips1 >> ${RESULTS}/opt-p01-001.pddl
