...
src/search/downward --domain_name transport-opt08-strips --problem_name p21.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astartransport-opt08-strips21 >> ${RESULTS}/p21.pddl
