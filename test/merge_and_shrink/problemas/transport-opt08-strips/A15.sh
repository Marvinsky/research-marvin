...
src/search/downward --domain_name transport-opt08-strips --problem_name p15.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astartransport-opt08-strips15 >> ${RESULTS}/p15.pddl
