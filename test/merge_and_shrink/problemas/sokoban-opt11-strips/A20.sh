...
src/search/downward --domain_name sokoban-opt11-strips --problem_name p20.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarsokoban-opt11-strips20 >> ${RESULTS}/p20.pddl
