...
src/search/downward --domain_name tidybot-opt11-strips --problem_name p04.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astartidybot-opt11-strips4 >> ${RESULTS}/p04.pddl
