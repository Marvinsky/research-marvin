...
src/search/downward --domain_name barman-opt11-strips --problem_name pfile04-013.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarbarman-opt11-strips13 >> ${RESULTS}/pfile04-013.pddl
