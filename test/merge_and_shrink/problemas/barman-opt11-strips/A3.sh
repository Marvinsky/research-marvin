...
src/search/downward --domain_name barman-opt11-strips --problem_name pfile01-003.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarbarman-opt11-strips3 >> ${RESULTS}/pfile01-003.pddl
