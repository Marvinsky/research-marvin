...
src/search/downward --domain_name barman-opt11-strips --problem_name pfile02-006.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarbarman-opt11-strips6 >> ${RESULTS}/pfile02-006.pddl
