#PBS -N merge_and_shrink_d18_p18
...
src/search/downward --domain_name visitall-opt11-strips --problem_name problem10-half.pddl --heuristic_name merge_and_shrink --search "astar(merge_and_shrink())" <  Astarvisitall-opt11-strips18 >> ${RESULTS}/problem10-half.pddl
