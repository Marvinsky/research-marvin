...
src/search/downward --domain_name visitall-opt11-strips --problem_name problem06-half.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarvisitall-opt11-strips10 >> ${RESULTS}/problem06-half.pddl
