...
src/search/downward --domain_name visitall-opt11-strips --problem_name problem05-full.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarvisitall-opt11-strips7 >> ${RESULTS}/problem05-full.pddl
