...
src/search/downward --domain_name openstacks-opt11-strips --problem_name p13.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astaropenstacks-opt11-strips13 >> ${RESULTS}/p13.pddl
