...
src/search/downward --domain_name openstacks-opt11-strips --problem_name p10.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astaropenstacks-opt11-strips10 >> ${RESULTS}/p10.pddl
