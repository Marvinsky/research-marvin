...
src/search/downward --domain_name woodworking-opt08-strips --problem_name p27.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarwoodworking-opt08-strips27 >> ${RESULTS}/p27.pddl
