...
src/search/downward --domain_name woodworking-opt08-strips --problem_name p26.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarwoodworking-opt08-strips26 >> ${RESULTS}/p26.pddl
