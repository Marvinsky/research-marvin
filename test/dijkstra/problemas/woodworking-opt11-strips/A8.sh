...
src/search/downward --domain_name woodworking-opt11-strips --problem_name p08.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarwoodworking-opt11-strips8 >> ${RESULTS}/p08.pddl
