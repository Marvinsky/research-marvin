...
src/search/downward --domain_name woodworking-opt11-strips --problem_name p10.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarwoodworking-opt11-strips10 >> ${RESULTS}/p10.pddl
