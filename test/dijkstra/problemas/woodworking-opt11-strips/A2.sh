...
src/search/downward --domain_name woodworking-opt11-strips --problem_name p02.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarwoodworking-opt11-strips2 >> ${RESULTS}/p02.pddl
