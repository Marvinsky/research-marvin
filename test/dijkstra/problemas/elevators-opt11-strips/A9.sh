...
src/search/downward --domain_name elevators-opt11-strips --problem_name p09.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarelevators-opt11-strips9 >> ${RESULTS}/p09.pddl
