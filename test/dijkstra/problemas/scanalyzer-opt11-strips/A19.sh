...
src/search/downward --domain_name scanalyzer-opt11-strips --problem_name p19.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarscanalyzer-opt11-strips19 >> ${RESULTS}/p19.pddl
