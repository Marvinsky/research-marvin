...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile05-018.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarparking-opt11-strips8 >> ${RESULTS}/pfile05-018.pddl
