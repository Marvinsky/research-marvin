...
src/search/downward --domain_name parking-opt11-strips --problem_name pfile05-020.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarparking-opt11-strips10 >> ${RESULTS}/pfile05-020.pddl
