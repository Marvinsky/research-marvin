...
src/search/downward --domain_name floortile-opt11-strips --problem_name opt-p10-019.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarfloortile-opt11-strips19 >> ${RESULTS}/opt-p10-019.pddl
