...
src/search/downward --domain_name elevators-opt08-strips --problem_name p25.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarelevators-opt08-strips25 >> ${RESULTS}/p25.pddl
