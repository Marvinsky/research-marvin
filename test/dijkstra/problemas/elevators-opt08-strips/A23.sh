...
src/search/downward --domain_name elevators-opt08-strips --problem_name p23.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarelevators-opt08-strips23 >> ${RESULTS}/p23.pddl
