...
src/search/downward --domain_name sokoban-opt08-strips --problem_name p01.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarsokoban-opt08-strips1 >> ${RESULTS}/p01.pddl
