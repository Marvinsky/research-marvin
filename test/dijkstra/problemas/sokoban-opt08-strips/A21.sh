...
src/search/downward --domain_name sokoban-opt08-strips --problem_name p21.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarsokoban-opt08-strips21 >> ${RESULTS}/p21.pddl
