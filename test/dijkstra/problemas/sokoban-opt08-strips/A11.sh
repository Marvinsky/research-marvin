...
src/search/downward --domain_name sokoban-opt08-strips --problem_name p11.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarsokoban-opt08-strips11 >> ${RESULTS}/p11.pddl
