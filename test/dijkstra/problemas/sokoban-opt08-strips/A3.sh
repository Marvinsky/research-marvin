...
src/search/downward --domain_name sokoban-opt08-strips --problem_name p03.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarsokoban-opt08-strips3 >> ${RESULTS}/p03.pddl
