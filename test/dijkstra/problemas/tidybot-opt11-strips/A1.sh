...
src/search/downward --domain_name tidybot-opt11-strips --problem_name p01.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astartidybot-opt11-strips1 >> ${RESULTS}/p01.pddl
