...
src/search/downward --domain_name tidybot-opt11-strips --problem_name p05.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astartidybot-opt11-strips5 >> ${RESULTS}/p05.pddl
