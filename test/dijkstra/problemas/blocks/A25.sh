...
src/search/downward --domain_name blocks --problem_name probBLOCKS-12-0.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarblocks25 >> ${RESULTS}/probBLOCKS-12-0.pddl
