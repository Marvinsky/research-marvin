...
src/search/downward --domain_name blocks --problem_name probBLOCKS-16-0.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarblocks33 >> ${RESULTS}/probBLOCKS-16-0.pddl
