...
src/search/downward --domain_name blocks --problem_name probBLOCKS-10-0.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarblocks19 >> ${RESULTS}/probBLOCKS-10-0.pddl
