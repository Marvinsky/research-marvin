...
src/search/downward --domain_name blocks --problem_name probBLOCKS-4-2.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarblocks3 >> ${RESULTS}/probBLOCKS-4-2.pddl
