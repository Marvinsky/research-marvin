...
src/search/downward --domain_name blocks --problem_name probBLOCKS-6-0.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarblocks7 >> ${RESULTS}/probBLOCKS-6-0.pddl
