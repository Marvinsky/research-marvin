...
src/search/downward --domain_name blocks --problem_name probBLOCKS-14-1.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarblocks30 >> ${RESULTS}/probBLOCKS-14-1.pddl
