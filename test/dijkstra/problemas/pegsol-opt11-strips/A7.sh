...
src/search/downward --domain_name pegsol-opt11-strips --problem_name p07.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarpegsol-opt11-strips7 >> ${RESULTS}/p07.pddl
