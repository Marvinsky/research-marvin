...
src/search/downward --domain_name pegsol-opt11-strips --problem_name p14.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarpegsol-opt11-strips14 >> ${RESULTS}/p14.pddl
