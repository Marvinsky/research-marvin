...
src/search/downward --domain_name barman-opt11-strips --problem_name pfile02-005.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarbarman-opt11-strips5 >> ${RESULTS}/pfile02-005.pddl
