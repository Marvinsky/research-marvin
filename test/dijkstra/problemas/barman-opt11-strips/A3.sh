...
src/search/downward --domain_name barman-opt11-strips --problem_name pfile01-003.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarbarman-opt11-strips3 >> ${RESULTS}/pfile01-003.pddl
