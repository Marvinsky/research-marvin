...
src/search/downward --domain_name barman-opt11-strips --problem_name pfile03-010.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarbarman-opt11-strips10 >> ${RESULTS}/pfile03-010.pddl
