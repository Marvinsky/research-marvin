...
src/search/downward --domain_name transport-opt08-strips --problem_name p13.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astartransport-opt08-strips13 >> ${RESULTS}/p13.pddl
