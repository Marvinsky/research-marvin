...
src/search/downward --domain_name parcprinter-opt11-strips --problem_name p15.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarparcprinter-opt11-strips15 >> ${RESULTS}/p15.pddl
