...
src/search/downward --domain_name openstacks-opt08-adl --problem_name p01.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astaropenstacks-opt08-adl1 >> ${RESULTS}/p01.pddl
