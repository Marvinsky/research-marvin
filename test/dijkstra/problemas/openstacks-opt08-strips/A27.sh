...
src/search/downward --domain_name openstacks-opt08-strips --problem_name p27.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astaropenstacks-opt08-strips27 >> ${RESULTS}/p27.pddl
