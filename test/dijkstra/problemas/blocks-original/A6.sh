...
src/search/downward --domain_name blocks --problem_name probBLOCKS-5-2.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarblocks6 >> ${RESULTS}/probBLOCKS-5-2.pddl
