...
src/search/downward --domain_name blocks --problem_name probBLOCKS-13-0.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarblocks27 >> ${RESULTS}/probBLOCKS-13-0.pddl
