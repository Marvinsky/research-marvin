...
src/search/downward --domain_name blocks --problem_name probBLOCKS-17-0.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarblocks35 >> ${RESULTS}/probBLOCKS-17-0.pddl
