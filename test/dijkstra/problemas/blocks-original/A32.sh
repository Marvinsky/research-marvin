...
src/search/downward --domain_name blocks --problem_name probBLOCKS-15-1.pddl --heuristic_name dijkstra --search "astar_dijkstra(dijkstra())" <  Astarblocks32 >> ${RESULTS}/probBLOCKS-15-1.pddl
