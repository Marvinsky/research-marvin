...
src/search/downward --domain_name blocks --problem_name probBLOCKS-9-0.pddl --heuristic_name ipdb --search "astar(ipdb())" <  Astarblocks16 >> ${RESULTS}/probBLOCKS-9-0.pddl
