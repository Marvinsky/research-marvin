...
src/search/downward --domain_name blocks --problem_name probBLOCKS-8-1.pddl --heuristic_name ipdb --search "astar(ipdb())" <  Astarblocks14 >> ${RESULTS}/probBLOCKS-8-1.pddl
