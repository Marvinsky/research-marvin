...
src/search/downward --domain_name blocks --problem_name probBLOCKS-11-0.pddl --heuristic_name ipdb --search "astar(ipdb())" <  Astarblocks22 >> ${RESULTS}/probBLOCKS-11-0.pddl
