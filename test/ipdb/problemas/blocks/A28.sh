...
src/search/downward --domain_name blocks --problem_name probBLOCKS-13-1.pddl --heuristic_name ipdb --search "astar(ipdb())" <  Astarblocks28 >> ${RESULTS}/probBLOCKS-13-1.pddl
