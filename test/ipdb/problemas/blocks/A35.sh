...
src/search/downward --domain_name blocks --problem_name probBLOCKS-17-0.pddl --heuristic_name ipdb --search "astar(ipdb())" <  Astarblocks35 >> ${RESULTS}/probBLOCKS-17-0.pddl
