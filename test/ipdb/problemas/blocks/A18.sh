...
src/search/downward --domain_name blocks --problem_name probBLOCKS-9-2.pddl --heuristic_name ipdb --search "astar(ipdb())" <  Astarblocks18 >> ${RESULTS}/probBLOCKS-9-2.pddl
