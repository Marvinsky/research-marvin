...
src/search/downward --domain_name blocks --problem_name probBLOCKS-6-0.pddl --heuristic_name ipdb --search "astar(ipdb())" <  Astarblocks7 >> ${RESULTS}/probBLOCKS-6-0.pddl
