...
src/search/downward --domain_name blocks --problem_name probBLOCKS-10-0.pddl --heuristic_name ipdb --search "astar_speed(ipdb())" <  Astarblocks11 >> ${RESULTS}/probBLOCKS-10-0.pddl
