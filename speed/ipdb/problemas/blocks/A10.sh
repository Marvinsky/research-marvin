...
src/search/downward --domain_name blocks --problem_name probBLOCKS-7-0.pddl --heuristic_name ipdb --search "astar_speed(ipdb())" <  Astarblocks10 >> ${RESULTS}/probBLOCKS-7-0.pddl
