...
src/search/downward --domain_name blocks --problem_name probBLOCKS-5-0.pddl --heuristic_name ipdb --search "astar_speed(ipdb())" <  Astarblocks4 >> ${RESULTS}/probBLOCKS-5-0.pddl
