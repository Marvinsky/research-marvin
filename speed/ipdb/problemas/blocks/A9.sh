...
src/search/downward --domain_name blocks --problem_name probBLOCKS-6-2.pddl --heuristic_name ipdb --search "astar_speed(ipdb())" <  Astarblocks9 >> ${RESULTS}/probBLOCKS-6-2.pddl
