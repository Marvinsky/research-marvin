...
args[10]:astar(min([gapdb(mp=1.0000000,size=2000000,disjoint=false)]))
GA type:=false)]))
args[10]:astar(min([gapdb(mp=1.0000000,size=2000000,disjoint=false)]))
GA type:=false)]))
use_saved_pdbs = 1
...
expanded_by_level = 1
f = 0 [1 evaluated, 0 expanded, t=0.00s, 3460 KB]
Best heuristic value: 6 [g=0, 1 evaluated, 0 expanded, t=0.00s, 3460 KB]
dominio = blocks
tarefa = probBLOCKS-4-0.pddl
heuristica = gapdb_deep
Directory created successfully.
cleared store_GA_patterns.
Best heuristic value: 5 [g=1, 3 evaluated, 1 expanded, t=0.00s, 3460 KB]
...
f = 1 [5 evaluated, 1 expanded, t=0.00s, 3460 KB]
Best heuristic value: 4 [g=2, 9 evaluated, 3 expanded, t=0.00s, 3460 KB]
...
f = 2 [17 evaluated, 5 expanded, t=0.00s, 3460 KB]
Best heuristic value: 3 [g=3, 24 evaluated, 9 expanded, t=0.00s, 3460 KB]
...
f = 3 [41 evaluated, 17 expanded, t=0.00s, 3460 KB]
Best heuristic value: 2 [g=4, 54 evaluated, 24 expanded, t=0.00s, 3460 KB]
...
f = 4 [77 evaluated, 41 expanded, t=0.00s, 3460 KB]
Best heuristic value: 1 [g=5, 84 evaluated, 54 expanded, t=0.00s, 3460 KB]
generated_by_level = 72
...
f = 5 [101 evaluated, 77 expanded, t=0.00s, 3460 KB]
Best heuristic value: 0 [g=6, 108 evaluated, 84 expanded, t=0.00s, 3460 KB]
...
f = 6 [125 evaluated, 101 expanded, t=0.00s, 3460 KB]
Solution found!
...
tarefa = probBLOCKS-4-0.pddl
heuristica = gapdb_deep
problem_name_gapdb = probBLOCKS-4-0_gapdb_6.pddl
Directory: gapdb_deep created.
Directory: SSCC created.
Directory: SSCCFile created.
name = probBLOCKS-4-0_gapdb_6_F_6.csv
