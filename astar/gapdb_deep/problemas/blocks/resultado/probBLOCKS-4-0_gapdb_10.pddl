...
args[10]:astar(min([gapdb(mp=0.3000000,size=2000000,disjoint=true)]))
GA type:t=true)]))
args[10]:astar(min([gapdb(mp=0.3000000,size=2000000,disjoint=true)]))
GA type:t=true)]))
use_saved_pdbs = 1
...
disjoint_patterns:,1
mutation_rate_string:mp:,0.3000000,
...
Best heuristic value: 5 [g=1, 3 evaluated, 1 expanded, t=0.00s, 3416 KB]
...
f = 1 [5 evaluated, 1 expanded, t=0.00s, 3416 KB]
Best heuristic value: 4 [g=2, 9 evaluated, 3 expanded, t=0.00s, 3416 KB]
...
f = 2 [17 evaluated, 5 expanded, t=0.00s, 3416 KB]
Best heuristic value: 3 [g=3, 24 evaluated, 9 expanded, t=0.00s, 3416 KB]
...
f = 3 [41 evaluated, 17 expanded, t=0.00s, 3416 KB]
Best heuristic value: 2 [g=4, 54 evaluated, 24 expanded, t=0.00s, 3416 KB]
...
f = 4 [77 evaluated, 41 expanded, t=0.00s, 3416 KB]
Best heuristic value: 1 [g=5, 84 evaluated, 54 expanded, t=0.00s, 3416 KB]
generated_by_level = 72
...
f = 5 [101 evaluated, 77 expanded, t=0.00s, 3416 KB]
Best heuristic value: 0 [g=6, 108 evaluated, 84 expanded, t=0.00s, 3416 KB]
...
f = 6 [125 evaluated, 101 expanded, t=0.00s, 3416 KB]
Solution found!
...
tarefa = probBLOCKS-4-0.pddl
heuristica = gapdb_deep
problem_name_gapdb = probBLOCKS-4-0_gapdb_10.pddl
Directory: gapdb_deep created.
Directory: SSCC created.
Directory: SSCCFile created.
name = probBLOCKS-4-0_gapdb_10_F_6.csv
