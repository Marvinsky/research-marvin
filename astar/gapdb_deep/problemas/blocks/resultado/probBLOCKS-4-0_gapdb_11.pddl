...
args[10]:astar(min([gapdb(mp=0.7000000,size=2000000,disjoint=false)]))
GA type:=false)]))
args[10]:astar(min([gapdb(mp=0.7000000,size=2000000,disjoint=false)]))
GA type:=false)]))
use_saved_pdbs = 1
...
disjoint_patterns:,0
mutation_rate_string:mp:,0.7000000,
...
expanded_by_level = 1
f = 0 [1 evaluated, 0 expanded, t=0.00s, 3416 KB]
Best heuristic value: 6 [g=0, 1 evaluated, 0 expanded, t=0.00s, 3416 KB]
dominio = blocks
