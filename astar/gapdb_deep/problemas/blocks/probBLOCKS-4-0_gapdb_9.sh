...
src/search/downward-release --use_saved_pdbs --domain_name blocks --problem_name probBLOCKS-4-0.pddl --heuristic_name gapdb_deep --problem_name_gapdb probBLOCKS-4-0_gapdb_9.pddl  --search "astar(min([gapdb(mp=0.4000000,size=2000000,disjoint=true)]))" <  Astarblocks10 > ${RESULTS}/probBLOCKS-4-0_gapdb_9.pddl
