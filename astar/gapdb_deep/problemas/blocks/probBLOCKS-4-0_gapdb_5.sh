...
src/search/downward-release --use_saved_pdbs --domain_name blocks --problem_name probBLOCKS-4-0.pddl --heuristic_name gapdb_deep --problem_name_gapdb probBLOCKS-4-0_gapdb_5.pddl  --search "astar(min([merge_and_shrink()]))" <  Astarblocks13 > ${RESULTS}/probBLOCKS-4-0_gapdb_5.pddl
