...
src/search/downward-release --F_boundary 24 --use_saved_pdbs --domain_name scanalyzer-opt11-strips --problem_name p04.pddl --heuristic_name gapdb --problem_name_gapdb p04_gapdb_3.pddl  --search "astar(min([gapdb(mp=,size=,disjoint=true)]))" <  Astarscanalyzer-opt11-strips4 > ${RESULTS}/p04_gapdb_3.pddl
