...
src/search/downward-release --F_boundary 34 --domain_name scanalyzer-opt11-strips --problem_name p13.pddl --heuristic_name gapdb --search "astar(min([gapdb(mp=0.5), automate_GAs]))" <  Astarscanalyzer-opt11-strips6 > ${RESULTS}/p13.pddl
