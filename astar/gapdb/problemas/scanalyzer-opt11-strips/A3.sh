...
src/search/downward-release --F_boundary 26 --domain_name scanalyzer-opt11-strips --problem_name p03.pddl --heuristic_name gapdb --search "astar(min([gapdb(mp=0.5), automate_GAs]))" <  Astarscanalyzer-opt11-strips3 > ${RESULTS}/p03.pddl
