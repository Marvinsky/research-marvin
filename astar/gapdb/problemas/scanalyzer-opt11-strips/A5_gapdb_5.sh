...
src/search/downward-release --F_boundary 26 --use_saved_pdbs --domain_name scanalyzer-opt11-strips --problem_name p11.pddl --heuristic_name gapdb --problem_name_gapdb p11_gapdb_4.pddl  --search "astar(min([gapdb(mp=,size=,disjoint=true)]))" <  Astarscanalyzer-opt11-strips5 > ${RESULTS}/p11_gapdb_4.pddl
