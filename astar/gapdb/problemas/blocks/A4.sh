...
src/search/downward-release --F_boundary 12 --domain_name blocks --problem_name probBLOCKS-5-0.pddl --heuristic_name gapdb --search "astar(min([gapdb(mp=0.5), automate_GAs]))" <  Astarblocks4 > ${RESULTS}/probBLOCKS-5-0.pddl
