...
log_file:dat/blocks/probBLOCKS-4-2.dat,g_plan_filename:sas_plan
is_open true
...
expanded_by_level = 1
f = 0 [1 evaluated, 0 expanded, t=0.00s, 3252 KB]
Best heuristic value: 1/1/1/1/1/1 [g=0, 1 evaluated, 0 expanded, t=0.00s, 3252 KB]
dominio = blocks
...
f = 4 [43 evaluated, 22 expanded, t=0.00s, 3384 KB]
calling evaluate
calling evaluate
calling evaluate
calling evaluate
...
f = 5 [65 evaluated, 43 expanded, t=0.00s, 3384 KB]
calling evaluate
calling evaluate
calling evaluate
calling evaluate
...
calling evaluate
calling evaluate
Best heuristic value: 0/0/0/0/0/0 [g=6, 76 evaluated, 53 expanded, t=0.00s, 3384 KB]
calling evaluate
calling evaluate
calling evaluate
calling evaluate
...
f = 6 [93 evaluated, 65 expanded, t=0.00s, 3384 KB]
calling evaluate
calling evaluate
calling evaluate
calling evaluate
...
f = 7 [109 evaluated, 93 expanded, t=0.00s, 3384 KB]
nodes_expanded.size() = 9
depth = 8
F_boundary = 6
count_level = 7
dominio = blocks
