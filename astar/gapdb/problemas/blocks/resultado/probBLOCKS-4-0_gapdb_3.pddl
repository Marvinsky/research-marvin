...
problem_name_mod = dat/blocks/probBLOCKS-4-0_gapdb_3.dat
Calling load_GA_Patterns_from_file
log_file:dat/blocks/probBLOCKS-4-0_gapdb_3.dat,g_plan_filename:sas_plan
...
expanded_by_level = 1
f = 0 [1 evaluated, 0 expanded, t=0.00s, 3248 KB]
Best heuristic value: 1 [g=0, 1 evaluated, 0 expanded, t=0.00s, 3248 KB]
dominio = blocks
tarefa = probBLOCKS-4-0_gapdb_3.pddl
heuristica = gapdb
...
f = 1 [5 evaluated, 1 expanded, t=0.00s, 3248 KB]
...
f = 2 [17 evaluated, 5 expanded, t=0.00s, 3248 KB]
...
f = 3 [41 evaluated, 17 expanded, t=0.00s, 3248 KB]
...
f = 4 [77 evaluated, 41 expanded, t=0.00s, 3248 KB]
generated_by_level = 72
...
f = 5 [101 evaluated, 77 expanded, t=0.00s, 3248 KB]
Best heuristic value: 0 [g=6, 108 evaluated, 84 expanded, t=0.00s, 3248 KB]
...
f = 6 [125 evaluated, 101 expanded, t=0.00s, 3248 KB]
Solution found!
