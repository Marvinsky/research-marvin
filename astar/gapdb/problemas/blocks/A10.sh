...
src/search/downward-release --F_boundary 20 --domain_name blocks --problem_name probBLOCKS-7-0.pddl --heuristic_name gapdb --search "astar(min([gapdb(mp=0.5), automate_GAs]))" <  Astarblocks10 > ${RESULTS}/probBLOCKS-7-0.pddl
