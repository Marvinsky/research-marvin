...
src/search/downward-release --F_boundary 16 --domain_name blocks --problem_name probBLOCKS-5-2.pddl --heuristic_name gapdb --search "astar(min([gapdb(mp=0.5), automate_GAs]))" <  Astarblocks6 > ${RESULTS}/probBLOCKS-5-2.pddl
