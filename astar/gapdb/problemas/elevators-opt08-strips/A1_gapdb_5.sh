...
src/search/downward-release --F_boundary 42 --use_saved_pdbs --domain_name elevators-opt08-strips --problem_name p01.pddl --heuristic_name gapdb --problem_name_gapdb p01_gapdb_4.pddl  --search "astar(min([gapdb(mp=0.8000000,size=2000000,disjoint=false)]))" <  Astarelevators-opt08-strips5 > ${RESULTS}/p01_gapdb_4.pddl
