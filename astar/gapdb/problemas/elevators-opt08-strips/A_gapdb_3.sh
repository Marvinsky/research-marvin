...
src/search/downward-release --F_boundary 42 --use_saved_pdbs --domain_name elevators-opt08-strips --problem_name p01_gapdb_2.pddl --heuristic_name gapdb --search "astar(min([gapdb(mp=0.8000000,size=20000,disjoint=false,eps=120,colls=5)]))" <  Astarelevators-opt08-strips3 > ${RESULTS}/p01_gapdb_2.pddl
