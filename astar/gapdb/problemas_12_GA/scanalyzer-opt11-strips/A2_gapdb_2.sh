...
src/search/downward-release --F_boundary 22 --use_saved_pdbs --domain_name scanalyzer-opt11-strips --problem_name p02.pddl --heuristic_name gapdb --problem_name_gapdb p02_gapdb_1.pddl  --search "astar(min([gapdb(mp=0.6000000,size=2000000,disjoint=true)]))" <  Astarscanalyzer-opt11-strips2 > ${RESULTS}/p02_gapdb_1.pddl
