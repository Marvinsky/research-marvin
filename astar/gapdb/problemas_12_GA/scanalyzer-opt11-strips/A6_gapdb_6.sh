...
src/search/downward-release --F_boundary 34 --use_saved_pdbs --domain_name scanalyzer-opt11-strips --problem_name p13.pddl --heuristic_name gapdb --problem_name_gapdb p13_gapdb_5.pddl  --search "astar(min([gapdb(mp=0.8000000,size=2000000,disjoint=false)]))" <  Astarscanalyzer-opt11-strips6 > ${RESULTS}/p13_gapdb_5.pddl
