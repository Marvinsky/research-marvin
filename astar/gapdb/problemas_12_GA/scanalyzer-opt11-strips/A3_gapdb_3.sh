...
src/search/downward-release --F_boundary 26 --use_saved_pdbs --domain_name scanalyzer-opt11-strips --problem_name p03.pddl --heuristic_name gapdb --problem_name_gapdb p03_gapdb_2.pddl  --search "astar(min([gapdb(mp=1.0000000,size=2000000,disjoint=true)]))" <  Astarscanalyzer-opt11-strips3 > ${RESULTS}/p03_gapdb_2.pddl
