...
args[12]:astar(min([gapdb(mp=0.7000000,size=2000000,disjoint=false)]))
GA type:nt=false)]))
args[12]:astar(min([gapdb(mp=0.7000000,size=2000000,disjoint=false)]))
GA type:nt=false)]))
use_saved_pdbs = 1
...
expanded_by_level = 1
f = 0 [1 evaluated, 0 expanded, t=0.00s, 3392 KB]
Best heuristic value: 6 [g=0, 1 evaluated, 0 expanded, t=0.00s, 3392 KB]
dominio = blocks
