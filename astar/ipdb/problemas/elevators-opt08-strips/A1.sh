...
src/search/downward-release --domain_name elevators-opt08-strips --problem_name p01.pddl --heuristic_name ipdb --search "astar(ipdb())" <  Astarelevators-opt08-strips1 >> ${RESULTS}/p01.pddl
