...
void create_kre_report(string Ni, string dumpFile, string fdist, string astar, string heuristic, string pasta, string fileName) {
	...
	output = fileName;    
        output =  pasta+"/"+output;
	output = "prediction/"+heuristic+"/reportss_regression/"+output;
...
void create_report1(string heuristic, string blind, int countProblems) {
	...
	do {
		...
		string  pastaReporte = "mkdir /home/marvin/marvin/prediction/"+heuristic+"/reportss_regression/"+pasta;
		...
		//Read the files to get the number of nodes by level of Dijkstra = A* + dijkstra
                //Interpolation
        	string output;
		output =  pasta+"/regression/"+output;
