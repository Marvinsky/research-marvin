...
void create_kre_report(string Ni, string unusedbf, string fdist, string astar, string heuristic, string pasta, string fileName) {
...
void create_report1(string heuristic, string blind, int countProblems) {
	...
	do {
		...
		//Read the files that contains the execution of the problem using A* + ipdb
                //Read the files from astar/ipdb/reportastar 
