...
src/search/downward-release --domain_name blocks --problem_name probBLOCKS-6-1.pddl --heuristic_name ipdb --search "astar_original(ipdb())" <  Astarblocks8 >> ${RESULTS}/probBLOCKS-6-1.pddl
