...
src/search/downward-release --domain_name blocks --problem_name probBLOCKS-5-1.pddl --heuristic_name ipdb --search "astar_original(ipdb())" <  Astarblocks5 >> ${RESULTS}/probBLOCKS-5-1.pddl
