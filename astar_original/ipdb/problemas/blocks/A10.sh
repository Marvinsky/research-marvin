...
src/search/downward-release --domain_name blocks --problem_name probBLOCKS-7-0.pddl --heuristic_name ipdb --search "astar_original(ipdb())" <  Astarblocks10 >> ${RESULTS}/probBLOCKS-7-0.pddl
