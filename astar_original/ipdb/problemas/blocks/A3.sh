...
src/search/downward-release --domain_name blocks --problem_name probBLOCKS-4-2.pddl --heuristic_name ipdb --search "astar_original(ipdb())" <  Astarblocks3 >> ${RESULTS}/probBLOCKS-4-2.pddl
