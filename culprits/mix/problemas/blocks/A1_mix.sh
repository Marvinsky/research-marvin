...
src/search/downward-release --global_probes 10  --domain_name blocks --problem_name probBLOCKS-4-0.pddl --heuristic_name mix --search "astar(min([hmax(), ipdb(), merge_and_shrink()]))" <  Astarblocks1 >> ${RESULTS}/probBLOCKS-4-0.pddl
