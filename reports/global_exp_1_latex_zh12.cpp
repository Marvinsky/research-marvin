...
void create_report1(string algorithm1, string algorithm2, string heuristic) {       
	...
	string model_to_write = "global_exp_1_latex_"+sufix1 + "_" + sufix2 + "_zh12";
	...
	//outputFile<<"\\centering\n";
        cout<<"\\caption{Experiment 1 - Comparison using "<<heuristic<<" heuristic}\n";
        outputFile<<"\\caption{Experiment 1 - Comparison using "<<heuristic<<" heuristic}\n";
