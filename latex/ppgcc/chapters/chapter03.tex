...
In the Figure \ref{fig:img_analysis_domains} we can see the distribution of the points in each domain. We use three different heuristics: ipdb, \texttt{LM-Cut} and 10 \texttt{GA-PDBs} which are represented by the symbols \ding{110} , \ding{108} and \ding{115} respectively.
...
We present in the Table \ref{tb:per_ss_made_correctly}
