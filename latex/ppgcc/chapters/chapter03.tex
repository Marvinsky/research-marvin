...
The \textit{Type System} is a partition of the states in the state space and it is calculated based of any property of each node in the search tree. \cite{Lelis2013CC}
