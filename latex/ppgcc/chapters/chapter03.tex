...
The type system is calculated based of any property of each node in the search tree. In addition, nodes will have the same type if they have the same $f$-value. This new search space that is created with the types is called partition of the search space. Lelis, (\citeyear{Lelis2013CC})
