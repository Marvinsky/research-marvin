...
\draw[very thick,cyan,loosely dotted] (-2,0) -- (10,0);
\draw[very thick,cyan,loosely dotted] (-2,-1) -- (10,-1);
\draw[very thick,cyan,loosely dotted] (-2,-2) -- (10,-2);
\draw[very thick,cyan,loosely dotted] (-2,-3) -- (10,-3);

$\node [xshift=1cm,yshift=2cm] (A) at (-2,-1.5) {Level 1};$
$\node [xshift=1cm,yshift=2cm] (A) at (-2,-2.5) {Level 2};$
$\node [xshift=1cm,yshift=2cm] (A) at (-2,-3.5) {Level 3};$
$\node [xshift=1cm,yshift=2cm] (A) at (-2,-4.5) {Level 4};$

\draw[black,fill=white] (2,0.5) circle (2ex);

\draw[red,fill=red] (1,-0.5) circle (2ex);
\draw[cyan,fill=cyan] (3,-0.5) circle (2ex);
\draw[red,fill=red] (5,-0.5) circle (2ex);

\draw[cyan,fill=cyan] (3,-1.5) circle (2ex);
\draw[red,fill=red] (4.5,-1.5) circle (2ex);
\draw[cyan,fill=cyan] (6,-1.5) circle (2ex);

\draw[red,fill=red] (3.5,-2.5) circle (2ex);
\draw[cyan,fill=cyan] (5.5,-2.5) circle (2ex);
\draw[red,fill=red] (7,-2.5) circle (2ex);
