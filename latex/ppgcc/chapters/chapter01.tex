...
\begin{enumerate}
\item In Chapter I, the background of the thesis is provided which also includes our motivation and define the scope. 
...
\item In Chapter IV, we explain the results obtained by using \texttt{GRHS} and compare it with other planner systems.
