...
The heuristic generators systems can create a large number of heuristics. Let's suppose $|\zeta| = $ 1000 heuristics were created considering the time and memory avaiable and we want to select the best N $=$ 100 heuristics. This would be: $${1000\choose 100} \approx 10\sp{138} possibilities$$
...
Some of the problems we are trying to solve are the optimal domains for International Planning Competition (\texttt{IPC}). The description of the domains are extracted from: <http://www.plg.inf.uc3m.es/ipc2011-deterministic/DomainsSequential.html>
