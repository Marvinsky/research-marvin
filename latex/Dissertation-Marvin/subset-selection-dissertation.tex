...
{
Abisrror, Marvin, M.Sc., \vspace{-1.0ex}Universidade Federal de Viçosa, Fevereiro 2016. \textbf{Selecção de um subconjunto de funções heurísticas\vspace{-1.0ex} para o planejamento de domínio independente}. Orientador: Levi Henrique Santana de Lelis.
}
...
{
Abisrror, Marvin, M.Sc., \vspace{-1.0ex}Universidade Federal de Viçosa, Febrary 2016. \textbf{On selecting heuristic\vspace{-1.0ex} function subset for domain independent-planning}. Adviser: Levi Henrique Santana de Lelis.
}
