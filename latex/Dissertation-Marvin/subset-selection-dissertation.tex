...
% minimize and maximize underneath the word
...
\savebox\myboxblockteststar{\blockworldsunordered{3/red,2/blue}}
...
% ---
\titulo{ON SELECTING HEURITIC \vspace{-1.5ex} FUNCTION SUBSET FOR DOMAIN INDEPENDENT-PLANNING}
\autor{MARVIN ABISRROR ZARATE}
\local{VIÇOSA \\MINAS GERAIS - BRASIL}
\data{2016}
\iffalse
...
\preambulo{Dissertação apresentada à \mbox{Universidade}
 			\mbox{Federal} de Viçosa, como parte das 
 			exigências do Programa de Pós-Graduação 
 			em Ciência da Computação, para 
 			a obtenção do título de \textit{Magister Scientiae}.}
% ---
...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   Trabalho aprovado. \imprimirlocal, 25 de fevereiro de 2016:
...
{
LATTES, Marvin Abisrror Zarate, M.Sc., \vspace{-1.0ex}Universidade Federal de Viçosa, Febrary 2016. On selecting heuristic\vspace{-1.0ex} function subset for domain independent-planning. Adviser: Levi Henrique Santana de Lelis.
}
