...
\noindent
State-space search algorithms have been used to solve important real-world problems, such as problems arising in Robotics \cite{DBLP:journals/corr/BadruddinA15}, domain-independent planning \cite{bonet2001planning}, chemistry \cite{XieXiangQun16}, biology \cite{clausen2015mapping}, engineering \cite{harman2009search}, among others. 
...
In this dissertation we study methods for selecting a subset of heuristic functions while minimizing approximations of the search tree size and of the running time of the A$\sp{*}$ \cite{hart1968formal} search algorithm while solving state-space search problems.
