...
\label{def:def_fculprits}
\end{definition}
%Note that the maximum number of different f-culprits in an A* search tree is equal to the number of nodes in the tree. Often in practice the number of f-culprits is much lower than the size of the tree.
