...
# heuristics:1
starting timings
node gen_and_exp_cost:3.00866e-06
...
h[,0,] is:,heur is not named,measured time cost:1.30955e-06,h:6
memory before deleting databases:
VmRSS memory: 8560 KB
...
______________________________________________________
F:8
F_bound:8,Peak memory=18.2344,nodes:13,Nodes mem_space:0.40625,F_boundary_Range:5
F:8
