...
# heuristics:1
starting timings
node gen_and_exp_cost:2.79762e-06
...
expanded states = 0
reopened states = 0
f: 10 [1 evaluated, 0 expanded, t=1.02s,generated_states:,0,additional_states:,0,],random_comb_index:-1
...
h[,0,] is:,heur is not named,measured time cost:1.57282e-06,h:10
memory before deleting databases:
VmRSS memory: 9272 KB
...
new_f_value:10
 ...
 applicable_ops.size() =  3
				...
				best_h = 6
				new best_h = 5
Best heuristic value: 5 [g=5, 7 evaluated, 5 expanded, t=1.13s]
				h = 7
				best_h = 5
_______________________________________
             calling step()            
...
new_f_value:10
 ...
 applicable_ops.size() =  4
				...
				best_h = 5
				new best_h = 4
Best heuristic value: 4 [g=6, 9 evaluated, 6 expanded, t=1.13s]
				h = 6
				best_h = 4
				h = 6
				best_h = 4
...
new_f_value:10
 ...
 applicable_ops.size() =  3
				...
				best_h = 4
				new best_h = 3
Best heuristic value: 3 [g=7, 12 evaluated, 7 expanded, t=1.13s]
				h = 5
				best_h = 3
_______________________________________
             calling step()            
...
new_f_value:10
 ...
 applicable_ops.size() =  3
				...
				best_h = 3
				new best_h = 2
Best heuristic value: 2 [g=8, 14 evaluated, 8 expanded, t=1.13s]
				h = 4
				best_h = 2
_______________________________________
             calling step()            
...
new_f_value:10
 ...
 applicable_ops.size() =  2
				...
				best_h = 2
				new best_h = 1
Best heuristic value: 1 [g=9, 16 evaluated, 9 expanded, t=1.13s]
_______________________________________
             calling step()            
_______________________________________
new_f_value:10
 ...
 applicable_ops.size() =  2
				...
				best_h = 1
				new best_h = 0
Best heuristic value: 0 [g=10, 17 evaluated, 10 expanded, t=1.13s]
_______________________________________
             calling step()            
_______________________________________
new_f_value:10
...
|          Solution found!        |
 _________________________________
overall generated nodes to last iter:,25,search_time:,1.13,overall time:,1.13
_______________________________________
             calling step()            
_______________________________________
new_f_value:12
...
f: 12 [17 evaluated, 11 expanded, t=1.13s,generated_states:,25,additional_states:,25,],random_comb_index:-1
last_jump:12,F_bound_to_print:0
gen_to_exp_ratio: 2.27273
F_bound:,12,Peak memory=,18.2344
______________________________________________________
F:12
F_bound:12,Peak memory=18.2344,nodes:17,Nodes mem_space:0.53125,F_boundary_Range:5
F:12
...
VmRSS memory: 1884 KB
VmHWM memory: 10448 KB
