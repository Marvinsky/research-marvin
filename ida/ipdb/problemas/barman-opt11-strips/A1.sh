...
RESULTS=/home/marvin/marvin/ida/ipdb/problemas/barman-opt11-strips/resultado
...
src/search/downward-release --global_probes 100 --domain_name barman-opt11-strips --problem_name pfile01-001.pddl --heuristic_name ipdb  --search "ida(ipdb(max_time=600))" <  Astarbarman-opt11-strips1 > ${RESULTS}/pfile01-001.pddl
