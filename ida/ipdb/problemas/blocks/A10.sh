...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-7-0.pddl --heuristic_name ipdb  --search "ida(ipdb())" <  Astarblocks10 > ${RESULTS}/probBLOCKS-7-0.pddl
