...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-6-0.pddl --heuristic_name ipdb  --search "ida(ipdb())" <  Astarblocks7 > ${RESULTS}/probBLOCKS-6-0.pddl
