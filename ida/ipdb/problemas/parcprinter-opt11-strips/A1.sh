...
src/search/downward-release --global_probes 100 --domain_name parcprinter-opt11-strips --problem_name p01.pddl --heuristic_name ipdb  --search "ida(ipdb(max_time=600))" <  Astarparcprinter-opt11-strips1 > ${RESULTS}/p01.pddl
