...
src/search/downward-release --global_probes 100 --domain_name scanalyzer-opt11-strips --problem_name p01.pddl --heuristic_name ipdb  --search "ida(ipdb())" <  Astarscanalyzer-opt11-strips1 > ${RESULTS}/p01.pddl
