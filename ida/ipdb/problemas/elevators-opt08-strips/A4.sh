...
src/search/downward-release --global_probes 100 --domain_name elevators-opt08-strips --problem_name p04.pddl --heuristic_name ipdb  --search "ida(ipdb())" <  Astarelevators-opt08-strips4 > ${RESULTS}/p04.pddl
