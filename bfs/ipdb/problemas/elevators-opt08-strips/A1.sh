...
RESULTS=/home/marvin/marvin/bfs/ipdb/problemas/elevators-opt08-strips/resultado
...
src/search/downward-release --global_probes 100 --domain_name elevators-opt08-strips --problem_name p01.pddl --heuristic_name ipdb  --search "bfs(ipdb())" <  Astarelevators-opt08-strips1 > ${RESULTS}/p01.pddl
