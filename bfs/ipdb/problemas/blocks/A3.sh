...
src/search/downward-release --global_probes 100 --domain_name blocks --problem_name probBLOCKS-4-2.pddl --heuristic_name ipdb  --search "bfs(ipdb())" <  Astarblocks3 > ${RESULTS}/probBLOCKS-4-2.pddl
